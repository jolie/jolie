...
class attributeUses extends NGCCHandler {
    ...
    public void enterElement(String $__uri, String $__local, String $__qname, Attributes $attrs) throws SAXException {
        ...
        case 3:
            {
                if((($ai = $runtime.getAttributeIndex("","processContents"))>=0 || (($ai = $runtime.getAttributeIndex("","namespace"))>=0 || ($__uri.equals("http://www.w3.org/2001/XMLSchema") && $__local.equals("annotation"))))) {
                    NGCCHandler h = new wildcardBody(this, super._source, $runtime, 307, wloc);
        ...
        case 19:
            {
                if(($__uri.equals("http://www.w3.org/2001/XMLSchema") && $__local.equals("annotation"))) {
                    NGCCHandler h = new annotation(this, super._source, $runtime, 325, null,AnnotationContext.ATTRIBUTE_USE);
                    spawnChildFromEnterElement(h, $__uri, $__local, $__qname, $attrs);
                }
                else {
        ...
        case 17:
            {
                if((($ai = $runtime.getAttributeIndex("","name"))>=0 || ($ai = $runtime.getAttributeIndex("","form"))>=0)) {
                    NGCCHandler h = new attributeDeclBody(this, super._source, $runtime, 332, locator,true,defaultValue,fixedValue);
                    spawnChildFromEnterElement(h, $__uri, $__local, $__qname, $attrs);
                }
                else {
                    if(($ai = $runtime.getAttributeIndex("","ref"))>=0) {
        ...
        case 9:
            {
                if(($__uri.equals("http://www.w3.org/2001/XMLSchema") && $__local.equals("annotation"))) {
                    NGCCHandler h = new annotation(this, super._source, $runtime, 314, null,AnnotationContext.ATTRIBUTE_USE);
                    spawnChildFromEnterElement(h, $__uri, $__local, $__qname, $attrs);
                }
                else {
    ...
    public void leaveElement(String $__uri, String $__local, String $__qname) throws SAXException {
        ...
        case 3:
            {
                if(((($ai = $runtime.getAttributeIndex("","processContents"))>=0 && ($__uri.equals("http://www.w3.org/2001/XMLSchema") && $__local.equals("anyAttribute"))) || (($__uri.equals("http://www.w3.org/2001/XMLSchema") && $__local.equals("anyAttribute")) || (($ai = $runtime.getAttributeIndex("","namespace"))>=0 && ($__uri.equals("http://www.w3.org/2001/XMLSchema") && $__local.equals("anyAttribute")))))) {
                    NGCCHandler h = new wildcardBody(this, super._source, $runtime, 307, wloc);
        ...
        case 18:
            {
                if(($__uri.equals("http://www.w3.org/2001/XMLSchema") && $__local.equals("attribute"))) {
                    NGCCHandler h = new foreignAttributes(this, super._source, $runtime, 323, null);
                    spawnChildFromLeaveElement(h, $__uri, $__local, $__qname);
                }
                else {
                    unexpectedLeaveElement($__qname);
    ...
    public void text(String $value) throws SAXException {
        ...
        case 12:
            {
                NGCCHandler h = new qname(this, super._source, $runtime, 317);
        ...
        case 22:
            {
                NGCCHandler h = new qname(this, super._source, $runtime, 328);
                spawnChildFromText(h, $value);
            }
            break;
        case 27:
