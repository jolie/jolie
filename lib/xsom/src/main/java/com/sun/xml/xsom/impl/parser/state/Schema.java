...
public class Schema extends NGCCHandler {
    ...
    private void action15()throws SAXException {
    	...
    	boolean elementFormDefault = false;
    	boolean attributeFormDefault = false;
    	String elementFormDefaultStr = test.getValue( "elementFormDefault" );
    	if ( elementFormDefaultStr != null && elementFormDefaultStr.equals( "qualified" ) )
    		elementFormDefault = true;
    	String attributeFormDefaultStr = test.getValue( "attributeFormDefault" );
    	if ( attributeFormDefaultStr != null && attributeFormDefaultStr.equals( "qualified" ) )
    		attributeFormDefault = true;

      if(!includeMode) {
        // importing
        if(tns==null) tns=""; // if not present, then the empty namespace
        $runtime.currentSchema = $runtime.parser.schemaSet.createSchema(tns,$runtime.copyLocator(),elementFormDefault,attributeFormDefault);
    ...
    public void enterElement(String $__uri, String $__local, String $__qname, Attributes $attrs) throws SAXException {
        ...
        case 36:
            {
                if((($__uri.equals("http://www.w3.org/2001/XMLSchema") && $__local.equals("attribute")) || (($__uri.equals("http://www.w3.org/2001/XMLSchema") && $__local.equals("group")) || (($__uri.equals("http://www.w3.org/2001/XMLSchema") && $__local.equals("element")) || (($__uri.equals("http://www.w3.org/2001/XMLSchema") && $__local.equals("redefine")) || (($__uri.equals("http://www.w3.org/2001/XMLSchema") && $__local.equals("include")) || (($__uri.equals("http://www.w3.org/2001/XMLSchema") && $__local.equals("attributeGroup")) || (($__uri.equals("http://www.w3.org/2001/XMLSchema") && $__local.equals("complexType")) || (($__uri.equals("http://www.w3.org/2001/XMLSchema") && $__local.equals("notation")) || (($__uri.equals("http://www.w3.org/2001/XMLSchema") && $__local.equals("import")) || (($__uri.equals("http://www.w3.org/2001/XMLSchema") && $__local.equals("simpleType")) || ($__uri.equals("http://www.w3.org/2001/XMLSchema") && $__local.equals("annotation"))))))))))))) {
                    NGCCHandler h = new foreignAttributes(this, super._source, $runtime, 136, null);
        ...
        case 27:
            {
                if((($ai = $runtime.getAttributeIndex("","final"))>=0 || (($ai = $runtime.getAttributeIndex("","abstract"))>=0 || (($ai = $runtime.getAttributeIndex("","name"))>=0 || (($ai = $runtime.getAttributeIndex("","fixed"))>=0 || (($ai = $runtime.getAttributeIndex("","block"))>=0 || (($ai = $runtime.getAttributeIndex("","form"))>=0 || ($ai = $runtime.getAttributeIndex("","default"))>=0))))))) {
                    NGCCHandler h = new elementDeclBody(this, super._source, $runtime, 48, locator,true);
                    spawnChildFromEnterElement(h, $__uri, $__local, $__qname, $attrs);
                }
                else {
                    unexpectedEnterElement($__qname);
        ...
        case 2:
            {
                if(($__uri.equals("http://www.w3.org/2001/XMLSchema") && $__local.equals("annotation"))) {
                    NGCCHandler h = new annotation(this, super._source, $runtime, 124, anno,AnnotationContext.SCHEMA);
                    spawnChildFromEnterElement(h, $__uri, $__local, $__qname, $attrs);
                }
                else {
                    if(($__uri.equals("http://www.w3.org/2001/XMLSchema") && $__local.equals("include"))) {
                        NGCCHandler h = new includeDecl(this, super._source, $runtime, 125);
                        spawnChildFromEnterElement(h, $__uri, $__local, $__qname, $attrs);
                    }
                    else {
                        if(($__uri.equals("http://www.w3.org/2001/XMLSchema") && $__local.equals("import"))) {
                            NGCCHandler h = new importDecl(this, super._source, $runtime, 126);
                            spawnChildFromEnterElement(h, $__uri, $__local, $__qname, $attrs);
                        }
                        else {
                            if(($__uri.equals("http://www.w3.org/2001/XMLSchema") && $__local.equals("redefine"))) {
                                NGCCHandler h = new redefine(this, super._source, $runtime, 127);
                                spawnChildFromEnterElement(h, $__uri, $__local, $__qname, $attrs);
                            }
                            else {
                                if(($__uri.equals("http://www.w3.org/2001/XMLSchema") && $__local.equals("element"))) {
                                    ...
                                    if(($__uri.equals("http://www.w3.org/2001/XMLSchema") && $__local.equals("simpleType"))) {
                                        NGCCHandler h = new simpleType(this, super._source, $runtime, 129);
                                        spawnChildFromEnterElement(h, $__uri, $__local, $__qname, $attrs);
                                    }
                                    else {
                                        if(($__uri.equals("http://www.w3.org/2001/XMLSchema") && $__local.equals("complexType"))) {
                                            NGCCHandler h = new complexType(this, super._source, $runtime, 130);
                                            spawnChildFromEnterElement(h, $__uri, $__local, $__qname, $attrs);
                                        }
                                        else {
                                            if(($__uri.equals("http://www.w3.org/2001/XMLSchema") && $__local.equals("attribute"))) {
                                                ...
                                                if(($__uri.equals("http://www.w3.org/2001/XMLSchema") && $__local.equals("group"))) {
                                                    NGCCHandler h = new group(this, super._source, $runtime, 132);
                                                    spawnChildFromEnterElement(h, $__uri, $__local, $__qname, $attrs);
                                                }
                                                else {
                                                    if(($__uri.equals("http://www.w3.org/2001/XMLSchema") && $__local.equals("notation"))) {
                                                        NGCCHandler h = new notation(this, super._source, $runtime, 133);
                                                        spawnChildFromEnterElement(h, $__uri, $__local, $__qname, $attrs);
                                                    }
                                                    else {
                                                        if(($__uri.equals("http://www.w3.org/2001/XMLSchema") && $__local.equals("attributeGroup"))) {
                                                            NGCCHandler h = new attributeGroupDecl(this, super._source, $runtime, 134);
                                                            spawnChildFromEnterElement(h, $__uri, $__local, $__qname, $attrs);
                                                        }
                                                        else {
        ...
        case 11:
            {
                if((($ai = $runtime.getAttributeIndex("","name"))>=0 || ($ai = $runtime.getAttributeIndex("","form"))>=0)) {
                    NGCCHandler h = new attributeDeclBody(this, super._source, $runtime, 30, locator,false,defaultValue,fixedValue);
                    spawnChildFromEnterElement(h, $__uri, $__local, $__qname, $attrs);
                }
                else {
                    unexpectedEnterElement($__qname);
        ...
        case 1:
            {
                if(($__uri.equals("http://www.w3.org/2001/XMLSchema") && $__local.equals("annotation"))) {
                    NGCCHandler h = new annotation(this, super._source, $runtime, 113, anno,AnnotationContext.SCHEMA);
                    spawnChildFromEnterElement(h, $__uri, $__local, $__qname, $attrs);
                }
                else {
                    if(($__uri.equals("http://www.w3.org/2001/XMLSchema") && $__local.equals("include"))) {
                        NGCCHandler h = new includeDecl(this, super._source, $runtime, 114);
                        spawnChildFromEnterElement(h, $__uri, $__local, $__qname, $attrs);
                    }
                    else {
                        if(($__uri.equals("http://www.w3.org/2001/XMLSchema") && $__local.equals("import"))) {
                            NGCCHandler h = new importDecl(this, super._source, $runtime, 115);
                            spawnChildFromEnterElement(h, $__uri, $__local, $__qname, $attrs);
                        }
                        else {
                            if(($__uri.equals("http://www.w3.org/2001/XMLSchema") && $__local.equals("redefine"))) {
                                NGCCHandler h = new redefine(this, super._source, $runtime, 116);
                                spawnChildFromEnterElement(h, $__uri, $__local, $__qname, $attrs);
                            }
                            else {
                                if(($__uri.equals("http://www.w3.org/2001/XMLSchema") && $__local.equals("element"))) {
                                    ...
                                    if(($__uri.equals("http://www.w3.org/2001/XMLSchema") && $__local.equals("simpleType"))) {
                                        ...
                                        if(($__uri.equals("http://www.w3.org/2001/XMLSchema") && $__local.equals("complexType"))) {
                                            NGCCHandler h = new complexType(this, super._source, $runtime, 119);
                                            spawnChildFromEnterElement(h, $__uri, $__local, $__qname, $attrs);
                                        }
                                        else {
                                            if(($__uri.equals("http://www.w3.org/2001/XMLSchema") && $__local.equals("attribute"))) {
                                                ...
                                                if(($__uri.equals("http://www.w3.org/2001/XMLSchema") && $__local.equals("group"))) {
                                                    NGCCHandler h = new group(this, super._source, $runtime, 121);
                                                    spawnChildFromEnterElement(h, $__uri, $__local, $__qname, $attrs);
                                                }
                                                else {
                                                    if(($__uri.equals("http://www.w3.org/2001/XMLSchema") && $__local.equals("notation"))) {
                                                        NGCCHandler h = new notation(this, super._source, $runtime, 122);
                                                        spawnChildFromEnterElement(h, $__uri, $__local, $__qname, $attrs);
                                                    }
                                                    else {
                                                        if(($__uri.equals("http://www.w3.org/2001/XMLSchema") && $__local.equals("attributeGroup"))) {
                                                            NGCCHandler h = new attributeGroupDecl(this, super._source, $runtime, 123);
                                                            spawnChildFromEnterElement(h, $__uri, $__local, $__qname, $attrs);
                                                        }
                                                        else {
                                                            unexpectedEnterElement($__qname);
    ...
    public void text(String $value) throws SAXException {
        ...
        case 51:
            {
                if($value.equals("unqualified")) {
                    NGCCHandler h = new qualification(this, super._source, $runtime, 153);
        ...
        case 43:
            {
                NGCCHandler h = new ersSet(this, super._source, $runtime, 143);
                spawnChildFromText(h, $value);
            }
            break;
        case 27:
        ...
        case 39:
            {
                NGCCHandler h = new erSet(this, super._source, $runtime, 138);
                spawnChildFromText(h, $value);
            }
            break;
        case 53:
        ...
        case 47:
            {
                if($value.equals("unqualified")) {
                	NGCCHandler h = new qualification(this, super._source, $runtime, 148);
                    spawnChildFromText(h, $value);
                }
