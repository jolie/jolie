...
public class CheckUtility
{
    ...
    /**
     * checks if the symbol table has all given symbols name in expectedSymbols, throws an Exception
    ...
    /**
     * checks if the ASTNode has all given types name in expectedTypes, throws an Exception is a
     * type is not found
     * 
    ...
    /**
     * checks if the given InterfaceDefinition id has all operation declared in expectedOps. And all
     * of those operation's types are already resolved
     * throws an Exception if some operation is missing in definition
     * 
