        ...
        switch ( in.fixedHeader().messageType() ) {
            ...
            case SUBACK:
                ...
                if( MqttProtocol.getQoS( pendingMpm ).equals( MqttQoS.AT_MOST_ONCE ) ){
                    MqttProtocol.releaseMessage( cc, MqttProtocol.getMessageID( pendingMpm ) );
                }
                break;
            case PUBACK:
            case PUBCOMP:
...
//                      null ) );
                ...
                MqttProtocol.markAsSentAndStopPing( cc, ( int ) cmReq.id() );
                break;
            case PUBREC:
                ...
                break;
            case PUBREL:
                // we received a QoS 2 response and its related PUBREç, we can foward it to CommCore and close
