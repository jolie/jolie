    ...
    public CommChannel createChannel(URI locationURI, OutputPort port) throws IOException {
                ...
                if ( !locationMap.containsKey(locationURI) ) {
                    ...
                    if ( "ini".equals( ss[0] ) ) {
                        ...
                        AutoHelper.throwIOException( "unsupported scheme: " + 
		...
		AutoHelper.assertIOException( location == null, 
                    "internal error: location is null" );
		AutoHelper.assertIOException( location.equals( Constants.LOCAL_LOCATION_KEYWORD ), 
