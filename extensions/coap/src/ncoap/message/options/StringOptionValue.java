...
import static ncoap.message.options.Option.URI_HOST;
import static ncoap.message.options.Option.URI_PATH;
import static ncoap.message.options.Option.URI_QUERY;
