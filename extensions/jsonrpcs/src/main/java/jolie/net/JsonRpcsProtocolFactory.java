...
public class JsonRpcsProtocolFactory extends CommProtocolFactory {
	public JsonRpcsProtocolFactory( CommCore commCore )
	...
	public CommProtocol createOutputProtocol( VariablePath configurationPath, URI location )
		...
		return new SSLProtocol(
			configurationPath,
			location,
			commCore().createOutputCommProtocol( "jsonrpc", configurationPath, location ),
			true );
	}
	...
	public CommProtocol createInputProtocol( VariablePath configurationPath, URI location )
		...
		return new SSLProtocol(
			configurationPath,
			location,
			commCore().createInputCommProtocol( "jsonrpc", configurationPath, location ),
			false );
	}
}
