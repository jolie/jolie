...
public abstract class AbstractListBuilder<B,E> {
	 ...
	 * or does nothing if the specified element is {@code null}.
	 * 
	 ...
	 */
	public final B addFirst( E e ) { return add( 0, e ); }

	/**
	 * Adds an element as the last element of the list being built, or
	 * does nothing if the element is {@code null}.
	 * 
	 * @param e element to be appended to the list being built
	 * @return this builder
	 ...
	 */
	public final B addLast( E e ) { return add( e ); }

	/**
	 * Appends all of the elements in the specified collection to the end of the list being built, 
	...
	/**
	 * Replaces the element at the specified position in the list being built
	 * with the specified element, or removes the element if the specified element is {@code null}.
	 * 
	 * @param index index of the element to replace
	 * @param e element to be stored at the specified position
	 * @return this builder
	...
	/**
	 * Replaces the element at the specified position in the list being built
	 * with the result of applying the specified operator to it.
	 * 
	 * @param index index of the element to replace
	...
	/**
	 * Replaces each element of the list being built with the result of applying the operator to that element.
	 * 
	...
	/**
	 * Removes the first occurrence of the specified element from the list being built, if it is present.
	 * 
