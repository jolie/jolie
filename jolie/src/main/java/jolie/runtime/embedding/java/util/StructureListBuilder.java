...
public class StructureListBuilder<E extends JolieValue, B> extends AbstractListBuilder<StructureListBuilder<E,B>, E> {
	...
	public StructureListBuilder( SequencedCollection<? extends JolieValue> elements, Function<JolieValue, E> mapper, Supplier<B> builder ) { 
	...
	/**
	 * Applies the specified function to a new builder instance, and 
	 * appends the result to the end of the list being built.
	 * 
	...
	/**
	 * Applies the specified function to a new builder instance, and 
	 * inserts the result at the specified position of the list being built.
	 * 
	 * @param f the function to apply to a new builder instance
	 * @return this builder
	 * @see AbstractListBuilder#add(int,Object)
	 */
	public StructureListBuilder<E,B> add( int index, Function<B,E> f ) { return add( index, f.apply( builder.get() ) ); }

	/**
	 * Applies the specified function to a new builder instance, and 
	 * replaces the element at the specified position in the list being built with the result.
	 * 
