 ...
 * @author martin
 */
public abstract class JolieContext implements Runnable
{
	private final Interpreter interpreter;
	private final String name;
	private static final AtomicInteger counter = new AtomicInteger( 0 );

	protected static String createContextName()
	{
		return "JolieContext-" + counter.getAndIncrement();
	}
	 ...
	 * @see Interpreter
	 */
	public JolieContext( Interpreter interpreter, String name )
	{
	 ...
	 * @see Interpreter
	 */
	public JolieContext( Interpreter interpreter )
	{
		this( interpreter, createContextName() );
	}
