...
public class ScopeBehaviour implements Behaviour
{
	...
	{
		private class MergeScopeBehaviour implements UnkillableBehaviour {
			@Override
		...
		private class ScopeTerminationBehaviour implements UnkillableBehaviour {
			@Override
			public void run( StatefulContext ctx ) throws FaultException, ExitingException
			{
				if ( ctx.isKilled() ) {
		...
		private class ScopeKillBehaviour implements UnkillableBehaviour {
		...
		private final ScopeBehaviour parent;
