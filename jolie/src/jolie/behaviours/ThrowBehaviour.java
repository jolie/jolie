...
public class ThrowBehaviour implements Behaviour
{
	final private String faultName;
	final private Expression expression;
	
	public ThrowBehaviour( String faultName, Expression expression )
	{
	...
	{
		return new ThrowBehaviour( faultName, expression );
	}
