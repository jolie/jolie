...
public class PostIncrementBehaviour implements Behaviour, Expression
{
	private final VariablePath path;

	public PostIncrementBehaviour( VariablePath varPath )
	{
		this.path = varPath;
	}
	...
	{
		return new PostIncrementBehaviour( (VariablePath)path.cloneExpression( reason ) );
	}
