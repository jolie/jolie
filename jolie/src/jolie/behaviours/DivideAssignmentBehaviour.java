 ...
 */
public class DivideAssignmentBehaviour implements Behaviour, Expression
{
	 ...
	 */
	public DivideAssignmentBehaviour( VariablePath varPath, Expression expression )
	{
	...
	{
		return new DivideAssignmentBehaviour(
