 ...
 */
public class MultiplyAssignmentBehaviour implements Behaviour, Expression
{
	 ...
	 */
	public MultiplyAssignmentBehaviour( VariablePath varPath, Expression expression )
	{
	...
	{
		return new MultiplyAssignmentBehaviour(
