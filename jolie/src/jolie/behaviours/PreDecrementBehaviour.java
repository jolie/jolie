...
public class PreDecrementBehaviour implements Behaviour, Expression
{
	final private VariablePath path;

	public PreDecrementBehaviour( VariablePath varPath )
	{
		this.path = varPath;
	}
	...
	{
		return new PreDecrementBehaviour( (VariablePath)path.cloneExpression( reason ) );
	}
