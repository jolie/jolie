...
public class Jolie2Java
{
    public static void main( String[] args )
	{
		try {
			...
			if ( args.length < 2 ) {
				throw new CommandLineException( "Syntax is: jolie2java [jolie options] <jolie filename> <output filename> [interface name list]" );
			}
			...
			System.out.println( "Syntax is: jolie2java [jolie options] <jolie filename> <output filename> [interface name list]" );
		} catch( IOException e ) {
			e.printStackTrace();
