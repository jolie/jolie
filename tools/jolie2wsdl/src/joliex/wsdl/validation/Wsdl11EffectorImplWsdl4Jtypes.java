 ...
 */
public class Wsdl11EffectorImplWsdl4Jtypes
{
	static final String tns = "http://www.italianasoftware.com/wsdl/FirstServiceByWSDL4J.wsdl";//.wsdl
	static final String tns_xsd = "http://www.italianasoftware.com/wsdl/FirstServiceByWSDL4J.xsd";//.wsdl
...
//                port.setBinding(b);
				...
				Logger.getLogger( Wsdl11EffectorImplWsdl4Jtypes.class.getName() ).log( Level.SEVERE, null, ex );
			} catch( WSDLException ex ) {
				Logger.getLogger( Wsdl11EffectorImplWsdl4Jtypes.class.getName() ).log( Level.SEVERE, null, ex );
			} finally {
				try {
	...
	public static void test02_types( String fileName, Element rootElement )
	{
		//if (fileName.equals("")) {fileName="./src/test/resources/prova_out.wsdl";}
		Definition rr;
		Schema sch;
...
//============================= TYPES =============================
				...
				//String subTypeNameFaultType="string";

				//rootElement = appendElementToDoc(document, "opName", rootElement);
...
//                port.setBinding(b);
	...
	public static Document createDocument()
	{
		...
		try {
			...
			e.printStackTrace();
			Logger.getLogger( Wsdl11EffectorImplWsdl4Jtypes.class.getName() ).log( Level.SEVERE, null, e );
	...
	public static Element appendElementToDoc( Document document, String opName, Element inputElement )
	{
	...
	public static Element appendElementToElementViaDoc( Document document, String opName, Element inputElement, Element elementToAppend )
	{
		System.out.println( " document=" + document );
		//elementReq.appendChild(cTypeReq).appendChild(sequenceReq).appendChild(elementResp).appendChild(elementFault);
		inputElement.appendChild( elementToAppend );

		return inputElement;
	}

	private static Element appendElement( String opName, Element elementReq, Element elementResp, Element elementFault )
	{
	...
	public static Element m( String opName, String subTypeNameReq, String subTypeNameResp, String subTypeNameFault, Element elementFault )
	{
		Document document;
		Element rootElement = null;
		DocumentBuilder db = null;
		...
		Element elementReq = addComplexTypeElementToDoc( document, opName, subTypeNameReq, subTypeNameReqType, String.valueOf( 1 ), String.valueOf( 1 ) );

		String subTypeNameRespType = "int";
		Element elementResp = addComplexTypeElementToDoc( document, opName + "Response", subTypeNameResp, subTypeNameRespType, String.valueOf( 1 ), String.valueOf( 1 ) );

		//String subTypeNameFaultType="string";
		//Element elementFault = createComplexTypeElement( document, opName+"Fault", subTypeNameFault, subTypeNameFaultType );
	...
	public static Element addComplexTypeElementToDoc( Document document, String opName, String subTypeNameReq, String subTypeNameReqType, String minOccurs, String maxOccurs )
	{
		Element elementReq = null;
		//if (document==null) throw new NullPointerException();
		try {
			elementReq = document.createElement( "xs:element" );
			//elementReq.setNodeValue("nodeValue");
			elementReq.setAttribute( "name", opName );
//
			Element cTypeReq = document.createElement( "xs:complexType" );
			...
			elementReqSub.setAttribute( "name", subTypeNameReq );
			elementReqSub.setAttribute( "type", subTypeNameReqType );
	...
	public static Element addSimpleTypeElementToDoc( Document document, String opName, String subTypeNameReq, String subTypeNameReqType /*String minOccurs,String maxOccurs*/ )
	{
...
//    }
	...
	public static void main( String[] arg )
	{
		...
		String provaTypes = "./provaTypes.wsdl";
		Document document = createDocument();
		String opName = "twice";
		Element elementReq = addComplexTypeElementToDoc( document, opName, "reqName", "int", String.valueOf( 1 ), String.valueOf( 1 ) );
