...
public class ProgramVisitor   extends GeneralProgramVisitor implements OLVisitor
{
	...
	{
		 // System.out.println(this.getClass().getCanonicalName()+" adding InterfaceDefinition n="+n);
	...
	{
         //System.out.println(this.getClass().getCanonicalName()+" adding InputPortInfo n"+n);
