...
public final class VoidBasicType extends jolie.runtime.embedding.java.TypedStructure {
	...
	public jolie.runtime.embedding.java.JolieNative.JolieVoid voidTag() {
		return voidTag;
	}
	...
	public static jolie.runtime.embedding.java.util.StructureListBuilder< VoidBasicType, Builder > listBuilder() {
		return new jolie.runtime.embedding.java.util.StructureListBuilder<>( VoidBasicType::builder );
	}

	public static jolie.runtime.embedding.java.util.StructureListBuilder< VoidBasicType, Builder > listBuilder(
		java.util.SequencedCollection< ? extends jolie.runtime.embedding.java.JolieValue > from ) {
		return from != null
			? new jolie.runtime.embedding.java.util.StructureListBuilder<>( from, VoidBasicType::from,
				VoidBasicType::builder )
			: listBuilder();
	}

	public static VoidBasicType from( jolie.runtime.embedding.java.JolieValue j )
		throws jolie.runtime.embedding.java.TypeValidationException {
		return new VoidBasicType(
			jolie.runtime.embedding.java.util.ValueManager.fieldFrom( j.getFirstChild( "void" ),
	...
	public static VoidBasicType fromValue( jolie.runtime.Value v ) throws jolie.runtime.typing.TypeCheckingException {
		...
		return new VoidBasicType(
			jolie.runtime.embedding.java.util.ValueManager.singleFieldFrom( v, "void",
	...
	public static class Builder {
		...
		private Builder( jolie.runtime.embedding.java.JolieValue j ) {
			this.voidTag = jolie.runtime.embedding.java.util.ValueManager.fieldFrom( j.getFirstChild( "void" ),
				c -> c.content() instanceof jolie.runtime.embedding.java.JolieNative.JolieVoid content ? content
					: null );
		}

		public Builder voidTag( jolie.runtime.embedding.java.JolieNative.JolieVoid voidTag ) {
