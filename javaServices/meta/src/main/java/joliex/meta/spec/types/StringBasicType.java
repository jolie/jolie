 ...
 *
 * <pre>
 * stringTag("string"): {@link jolie.runtime.embedding.java.JolieNative.JolieVoid}
...
public final class StringBasicType extends jolie.runtime.embedding.java.TypedStructure {
	...
	private final jolie.runtime.embedding.java.JolieNative.JolieVoid stringTag;
	...
	public StringBasicType( jolie.runtime.embedding.java.JolieNative.JolieVoid stringTag,
		java.util.SequencedCollection< joliex.meta.spec.types.StringRefinement > refinements ) {
		this.stringTag = jolie.runtime.embedding.java.util.ValueManager.validated( "stringTag", stringTag );
		this.refinements = jolie.runtime.embedding.java.util.ValueManager.validated( "refinements", refinements, 0,
			2147483647, t -> t );
	}

	public jolie.runtime.embedding.java.JolieNative.JolieVoid stringTag() {
		return stringTag;
	}

	public java.util.List< joliex.meta.spec.types.StringRefinement > refinements() {
		return refinements;
	}
	...
	public static jolie.runtime.embedding.java.util.StructureListBuilder< StringBasicType, Builder > listBuilder() {
		return new jolie.runtime.embedding.java.util.StructureListBuilder<>( StringBasicType::builder );
	}

	public static jolie.runtime.embedding.java.util.StructureListBuilder< StringBasicType, Builder > listBuilder(
		java.util.SequencedCollection< ? extends jolie.runtime.embedding.java.JolieValue > from ) {
		return from != null
			? new jolie.runtime.embedding.java.util.StructureListBuilder<>( from, StringBasicType::from,
				StringBasicType::builder )
			: listBuilder();
	}

	public static StringBasicType from( jolie.runtime.embedding.java.JolieValue j )
		throws jolie.runtime.embedding.java.TypeValidationException {
		return new StringBasicType(
			jolie.runtime.embedding.java.util.ValueManager.fieldFrom( j.getFirstChild( "string" ),
			...
			jolie.runtime.embedding.java.util.ValueManager.fieldFrom(
				...
				joliex.meta.spec.types.StringRefinement::from ) );
	}
	...
	public static StringBasicType fromValue( jolie.runtime.Value v ) throws jolie.runtime.typing.TypeCheckingException {
		...
		return new StringBasicType(
			jolie.runtime.embedding.java.util.ValueManager.singleFieldFrom( v, "string",
			...
			jolie.runtime.embedding.java.util.ValueManager.vectorFieldFrom( v, "refinements",
				joliex.meta.spec.types.StringRefinement::fromValue ) );
	}

	public static jolie.runtime.Value toValue( StringBasicType t ) {
		final jolie.runtime.Value v = jolie.runtime.Value.create();

		v.getFirstChild( "string" ).setValue( t.stringTag().value() );
		t.refinements().forEach(
			c -> v.getNewChild( "refinements" ).deepCopy( joliex.meta.spec.types.StringRefinement.toValue( c ) ) );
	...
	public static class Builder {
		...
		private jolie.runtime.embedding.java.JolieNative.JolieVoid stringTag;
		private java.util.SequencedCollection< joliex.meta.spec.types.StringRefinement > refinements;

		private Builder() {}

		private Builder( jolie.runtime.embedding.java.JolieValue j ) {
			this.stringTag = jolie.runtime.embedding.java.util.ValueManager.fieldFrom( j.getFirstChild( "string" ),
				c -> c.content() instanceof jolie.runtime.embedding.java.JolieNative.JolieVoid content ? content
					: null );
		...
		public Builder stringTag( jolie.runtime.embedding.java.JolieNative.JolieVoid stringTag ) {
		...
		public Builder refinements(
			java.util.function.Function< joliex.meta.spec.types.StringRefinement.ListBuilder, java.util.List< joliex.meta.spec.types.StringRefinement > > f ) {
			return refinements( f.apply( joliex.meta.spec.types.StringRefinement.listBuilder() ) );
		}

		public StringBasicType build() {
			return new StringBasicType( stringTag, refinements );
		}
	}
}
