...
public final class StringRefinementRegex extends jolie.runtime.embedding.java.TypedStructure {
	...
	public static jolie.runtime.embedding.java.util.StructureListBuilder< StringRefinementRegex, Builder > listBuilder() {
		return new jolie.runtime.embedding.java.util.StructureListBuilder<>( StringRefinementRegex::builder );
	}

	public static jolie.runtime.embedding.java.util.StructureListBuilder< StringRefinementRegex, Builder > listBuilder(
		java.util.SequencedCollection< ? extends jolie.runtime.embedding.java.JolieValue > from ) {
		return from != null
			? new jolie.runtime.embedding.java.util.StructureListBuilder<>( from, StringRefinementRegex::from,
				StringRefinementRegex::builder )
			: listBuilder();
	}

	public static StringRefinementRegex from( jolie.runtime.embedding.java.JolieValue j )
		throws jolie.runtime.embedding.java.TypeValidationException {
		return new StringRefinementRegex(
			jolie.runtime.embedding.java.util.ValueManager.fieldFrom( j.getFirstChild( "regex" ),
				c -> c.content() instanceof jolie.runtime.embedding.java.JolieNative.JolieString content
					? content.value()
					: null ) );
	}

	public static StringRefinementRegex fromValue( jolie.runtime.Value v )
		throws jolie.runtime.typing.TypeCheckingException {
		jolie.runtime.embedding.java.util.ValueManager.requireChildren( v, FIELD_KEYS );
		return new StringRefinementRegex(
			jolie.runtime.embedding.java.util.ValueManager.singleFieldFrom( v, "regex",
	...
	public static class Builder {
		...
		private Builder( jolie.runtime.embedding.java.JolieValue j ) {
			this.regex = jolie.runtime.embedding.java.util.ValueManager.fieldFrom( j.getFirstChild( "regex" ),
				c -> c.content() instanceof jolie.runtime.embedding.java.JolieNative.JolieString content
					? content.value()
					: null );
		}
