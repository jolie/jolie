...
public final class InterfaceDef extends jolie.runtime.embedding.java.TypedStructure {
    ...
    public InterfaceDef( joliex.meta.spec.types.Location textLocation, java.util.SequencedCollection<joliex.meta.spec.types.Operation> operations, joliex.meta.spec.types.LocatedString name ) {
    ...
    public static jolie.runtime.embedding.java.util.StructureListBuilder<InterfaceDef, Builder> listBuilder() { return new jolie.runtime.embedding.java.util.StructureListBuilder<>( InterfaceDef::builder ); }
    public static jolie.runtime.embedding.java.util.StructureListBuilder<InterfaceDef, Builder> listBuilder( java.util.SequencedCollection<? extends jolie.runtime.embedding.java.JolieValue> from ) {
        return from != null ? new jolie.runtime.embedding.java.util.StructureListBuilder<>( from, InterfaceDef::from, InterfaceDef::builder ) : listBuilder();
    }
    
    public static InterfaceDef from( jolie.runtime.embedding.java.JolieValue j ) throws jolie.runtime.embedding.java.TypeValidationException {
