...
public final class LocatedString extends jolie.runtime.embedding.java.TypedStructure {
	...
	public static jolie.runtime.embedding.java.util.StructureListBuilder< LocatedString, Builder > listBuilder() {
		return new jolie.runtime.embedding.java.util.StructureListBuilder<>( LocatedString::builder );
	}

	public static jolie.runtime.embedding.java.util.StructureListBuilder< LocatedString, Builder > listBuilder(
		java.util.SequencedCollection< ? extends jolie.runtime.embedding.java.JolieValue > from ) {
		return from != null
			? new jolie.runtime.embedding.java.util.StructureListBuilder<>( from, LocatedString::from,
				LocatedString::builder )
			: listBuilder();
	}

	public static LocatedString from( jolie.runtime.embedding.java.JolieValue j )
