...
public final class IntRange extends jolie.runtime.embedding.java.TypedStructure {
    ...
    public static jolie.runtime.embedding.java.util.StructureListBuilder<IntRange, Builder> listBuilder() { return new jolie.runtime.embedding.java.util.StructureListBuilder<>( IntRange::builder ); }
    public static jolie.runtime.embedding.java.util.StructureListBuilder<IntRange, Builder> listBuilder( java.util.SequencedCollection<? extends jolie.runtime.embedding.java.JolieValue> from ) {
        return from != null ? new jolie.runtime.embedding.java.util.StructureListBuilder<>( from, IntRange::from, IntRange::builder ) : listBuilder();
    }
    
    public static IntRange from( jolie.runtime.embedding.java.JolieValue j ) throws jolie.runtime.embedding.java.TypeValidationException {
        return new IntRange(
