 ...
 * <pre>
 * _int("int"): {@link jolie.runtime.embedding.java.JolieNative.JolieVoid}
...
public final class IntBasicType extends jolie.runtime.embedding.java.TypedStructure {
    ...
    private final jolie.runtime.embedding.java.JolieNative.JolieVoid _int;
    ...
    public IntBasicType( jolie.runtime.embedding.java.JolieNative.JolieVoid _int, java.util.SequencedCollection<joliex.meta.spec.types.IntRefinement> refinements ) {
        this._int = jolie.runtime.embedding.java.util.ValueManager.validated( "_int", _int );
        this.refinements = jolie.runtime.embedding.java.util.ValueManager.validated( "refinements", refinements, 0, 2147483647, t -> t );
    }
    
    public jolie.runtime.embedding.java.JolieNative.JolieVoid _int() { return _int; }
    ...
    public static IntBasicType from( jolie.runtime.embedding.java.JolieValue j ) throws jolie.runtime.embedding.java.TypeValidationException {
        return new IntBasicType(
            jolie.runtime.embedding.java.util.ValueManager.fieldFrom( j.getFirstChild( "int" ), c -> c.content() instanceof jolie.runtime.embedding.java.JolieNative.JolieVoid content ? content : null ),
    ...
    public static IntBasicType fromValue( jolie.runtime.Value v ) throws jolie.runtime.typing.TypeCheckingException {
        ...
        return new IntBasicType(
            jolie.runtime.embedding.java.util.ValueManager.singleFieldFrom( v, "int", jolie.runtime.embedding.java.JolieNative.JolieVoid::fromValue ),
    ...
    public static jolie.runtime.Value toValue( IntBasicType t ) {
        ...
        v.getFirstChild( "int" ).setValue( t._int().value() );
    ...
    public static class Builder {
        ...
        private jolie.runtime.embedding.java.JolieNative.JolieVoid _int;
        private java.util.SequencedCollection<joliex.meta.spec.types.IntRefinement> refinements;
        
        private Builder() {}
        private Builder( jolie.runtime.embedding.java.JolieValue j ) {
            this._int = jolie.runtime.embedding.java.util.ValueManager.fieldFrom( j.getFirstChild( "int" ), c -> c.content() instanceof jolie.runtime.embedding.java.JolieNative.JolieVoid content ? content : null );
        ...
        public Builder _int( jolie.runtime.embedding.java.JolieNative.JolieVoid _int ) { this._int = _int; return this; }
        ...
        public IntBasicType build() {
            return new IntBasicType( _int, refinements );
        }
    }
}