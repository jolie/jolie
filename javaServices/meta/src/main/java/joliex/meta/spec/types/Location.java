...
public final class Location extends jolie.runtime.embedding.java.TypedStructure {
	...
	public joliex.meta.spec.types.Range range() {
		return range;
	}
	...
	public static jolie.runtime.embedding.java.util.StructureListBuilder< Location, Builder > listBuilder() {
		return new jolie.runtime.embedding.java.util.StructureListBuilder<>( Location::builder );
	}

	public static jolie.runtime.embedding.java.util.StructureListBuilder< Location, Builder > listBuilder(
		java.util.SequencedCollection< ? extends jolie.runtime.embedding.java.JolieValue > from ) {
		return from != null
			? new jolie.runtime.embedding.java.util.StructureListBuilder<>( from, Location::from, Location::builder )
			: listBuilder();
	}

	public static Location from( jolie.runtime.embedding.java.JolieValue j )
		...
		return new Location(
			jolie.runtime.embedding.java.util.ValueManager.fieldFrom( j.getFirstChild( "range" ),
				joliex.meta.spec.types.Range::from ),
			jolie.runtime.embedding.java.util.ValueManager.fieldFrom( j.getFirstChild( "source" ),
	...
	public static Location fromValue( jolie.runtime.Value v ) throws jolie.runtime.typing.TypeCheckingException {
		...
		return new Location(
			jolie.runtime.embedding.java.util.ValueManager.singleFieldFrom( v, "range",
				joliex.meta.spec.types.Range::fromValue ),
			jolie.runtime.embedding.java.util.ValueManager.singleFieldFrom( v, "source",
	...
	public static class Builder {
		...
		private Builder( jolie.runtime.embedding.java.JolieValue j ) {
			this.range = jolie.runtime.embedding.java.util.ValueManager.fieldFrom( j.getFirstChild( "range" ),
				joliex.meta.spec.types.Range::from );
			this.source = jolie.runtime.embedding.java.util.ValueManager.fieldFrom( j.getFirstChild( "source" ),
				c -> c.content() instanceof jolie.runtime.embedding.java.JolieNative.JolieString content
					? content.value()
					: null );
		}

		public Builder range( joliex.meta.spec.types.Range range ) {
			this.range = range;
			return this;
		}

		public Builder range(
			java.util.function.Function< joliex.meta.spec.types.Range.Builder, joliex.meta.spec.types.Range > f ) {
			return range( f.apply( joliex.meta.spec.types.Range.builder() ) );
		}
