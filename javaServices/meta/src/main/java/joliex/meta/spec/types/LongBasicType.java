...
public final class LongBasicType extends jolie.runtime.embedding.java.TypedStructure {
	...
	public LongBasicType( jolie.runtime.embedding.java.JolieNative.JolieVoid longTag,
		java.util.SequencedCollection< joliex.meta.spec.types.LongRefinement > refinements ) {
	...
	public jolie.runtime.embedding.java.JolieNative.JolieVoid longTag() {
		return longTag;
	}

	public java.util.List< joliex.meta.spec.types.LongRefinement > refinements() {
		return refinements;
	}
	...
	public static jolie.runtime.embedding.java.util.StructureListBuilder< LongBasicType, Builder > listBuilder() {
		return new jolie.runtime.embedding.java.util.StructureListBuilder<>( LongBasicType::builder );
	}

	public static jolie.runtime.embedding.java.util.StructureListBuilder< LongBasicType, Builder > listBuilder(
		java.util.SequencedCollection< ? extends jolie.runtime.embedding.java.JolieValue > from ) {
		return from != null
			? new jolie.runtime.embedding.java.util.StructureListBuilder<>( from, LongBasicType::from,
				LongBasicType::builder )
			: listBuilder();
	}

	public static LongBasicType from( jolie.runtime.embedding.java.JolieValue j )
		throws jolie.runtime.embedding.java.TypeValidationException {
		return new LongBasicType(
			jolie.runtime.embedding.java.util.ValueManager.fieldFrom( j.getFirstChild( "long" ),
			...
			jolie.runtime.embedding.java.util.ValueManager.fieldFrom(
				...
				joliex.meta.spec.types.LongRefinement::from ) );
	}
	...
	public static LongBasicType fromValue( jolie.runtime.Value v ) throws jolie.runtime.typing.TypeCheckingException {
		...
		return new LongBasicType(
			jolie.runtime.embedding.java.util.ValueManager.singleFieldFrom( v, "long",
			...
			jolie.runtime.embedding.java.util.ValueManager.vectorFieldFrom( v, "refinements",
				joliex.meta.spec.types.LongRefinement::fromValue ) );
	}
	...
	public static jolie.runtime.Value toValue( LongBasicType t ) {
		...
		t.refinements().forEach(
			c -> v.getNewChild( "refinements" ).deepCopy( joliex.meta.spec.types.LongRefinement.toValue( c ) ) );
	...
	public static class Builder {
		...
		private Builder( jolie.runtime.embedding.java.JolieValue j ) {
			this.longTag = jolie.runtime.embedding.java.util.ValueManager.fieldFrom( j.getFirstChild( "long" ),
				c -> c.content() instanceof jolie.runtime.embedding.java.JolieNative.JolieVoid content ? content
					: null );
		...
		public Builder longTag( jolie.runtime.embedding.java.JolieNative.JolieVoid longTag ) {
		...
		public Builder refinements(
			java.util.function.Function< jolie.runtime.embedding.java.util.StructureListBuilder< joliex.meta.spec.types.LongRefinement, joliex.meta.spec.types.LongRefinement.Builder >, java.util.List< joliex.meta.spec.types.LongRefinement > > f ) {
