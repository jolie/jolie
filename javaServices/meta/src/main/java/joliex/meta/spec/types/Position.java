...
public final class Position extends jolie.runtime.embedding.java.TypedStructure {
	...
	public java.lang.Integer character() {
		return character;
	}
	...
	public static jolie.runtime.embedding.java.util.StructureListBuilder< Position, Builder > listBuilder() {
		return new jolie.runtime.embedding.java.util.StructureListBuilder<>( Position::builder );
	}

	public static jolie.runtime.embedding.java.util.StructureListBuilder< Position, Builder > listBuilder(
		java.util.SequencedCollection< ? extends jolie.runtime.embedding.java.JolieValue > from ) {
		return from != null
			? new jolie.runtime.embedding.java.util.StructureListBuilder<>( from, Position::from, Position::builder )
			: listBuilder();
	}

	public static Position from( jolie.runtime.embedding.java.JolieValue j )
		throws jolie.runtime.embedding.java.TypeValidationException {
		return new Position(
			jolie.runtime.embedding.java.util.ValueManager.fieldFrom( j.getFirstChild( "character" ),
				c -> c.content() instanceof jolie.runtime.embedding.java.JolieNative.JolieInt content ? content.value()
					: null ),
			jolie.runtime.embedding.java.util.ValueManager.fieldFrom( j.getFirstChild( "line" ),
				c -> c.content() instanceof jolie.runtime.embedding.java.JolieNative.JolieInt content ? content.value()
					: null ) );
	}
	...
	public static Position fromValue( jolie.runtime.Value v ) throws jolie.runtime.typing.TypeCheckingException {
		...
		return new Position(
			jolie.runtime.embedding.java.util.ValueManager.singleFieldFrom( v, "character",
				jolie.runtime.embedding.java.JolieNative.JolieInt::fieldFromValue ),
			jolie.runtime.embedding.java.util.ValueManager.singleFieldFrom( v, "line",
				jolie.runtime.embedding.java.JolieNative.JolieInt::fieldFromValue ) );
	}
	...
	public static class Builder {
		...
		private Builder( jolie.runtime.embedding.java.JolieValue j ) {
			this.character = jolie.runtime.embedding.java.util.ValueManager.fieldFrom( j.getFirstChild( "character" ),
				c -> c.content() instanceof jolie.runtime.embedding.java.JolieNative.JolieInt content ? content.value()
					: null );
			this.line = jolie.runtime.embedding.java.util.ValueManager.fieldFrom( j.getFirstChild( "line" ),
				c -> c.content() instanceof jolie.runtime.embedding.java.JolieNative.JolieInt content ? content.value()
					: null );
		}

		public Builder character( java.lang.Integer character ) {
			this.character = character;
			return this;
		}

		public Builder line( java.lang.Integer line ) {
			this.line = line;
			return this;
		}
