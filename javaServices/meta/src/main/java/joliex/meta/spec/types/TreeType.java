...
public final class TreeType extends jolie.runtime.embedding.java.TypedStructure {
    ...
    public TreeType( joliex.meta.spec.types.Location textLocation, joliex.meta.spec.types.BasicType basicType, joliex.meta.spec.types.TreeNodeType rest, java.util.SequencedCollection<joliex.meta.spec.types.TreeNodeType> nodes, joliex.meta.spec.types.Documentation documentation ) {
    ...
    public joliex.meta.spec.types.BasicType basicType() { return basicType; }
    public java.util.Optional<joliex.meta.spec.types.TreeNodeType> rest() { return java.util.Optional.ofNullable( rest ); }
    public java.util.List<joliex.meta.spec.types.TreeNodeType> nodes() { return nodes; }
    ...
    public static jolie.runtime.embedding.java.util.StructureListBuilder<TreeType, Builder> listBuilder() { return new jolie.runtime.embedding.java.util.StructureListBuilder<>( TreeType::builder ); }
    public static jolie.runtime.embedding.java.util.StructureListBuilder<TreeType, Builder> listBuilder( java.util.SequencedCollection<? extends jolie.runtime.embedding.java.JolieValue> from ) {
        return from != null ? new jolie.runtime.embedding.java.util.StructureListBuilder<>( from, TreeType::from, TreeType::builder ) : listBuilder();
    }
    
    public static TreeType from( jolie.runtime.embedding.java.JolieValue j ) throws jolie.runtime.embedding.java.TypeValidationException {
        return new TreeType(
            ...
            jolie.runtime.embedding.java.util.ValueManager.fieldFrom( j.getFirstChild( "basicType" ), joliex.meta.spec.types.BasicType::from ),
            jolie.runtime.embedding.java.util.ValueManager.fieldFrom( j.getFirstChild( "rest" ), joliex.meta.spec.types.TreeNodeType::from ),
            jolie.runtime.embedding.java.util.ValueManager.fieldFrom( j.getChildOrDefault( "nodes", java.util.List.of() ), joliex.meta.spec.types.TreeNodeType::from ),
    ...
    public static TreeType fromValue( jolie.runtime.Value v ) throws jolie.runtime.typing.TypeCheckingException {
        ...
        return new TreeType(
            ...
            jolie.runtime.embedding.java.util.ValueManager.singleFieldFrom( v, "basicType", joliex.meta.spec.types.BasicType::fromValue ),
            jolie.runtime.embedding.java.util.ValueManager.singleFieldFrom( v, "rest", joliex.meta.spec.types.TreeNodeType::fromValue ),
            jolie.runtime.embedding.java.util.ValueManager.vectorFieldFrom( v, "nodes", joliex.meta.spec.types.TreeNodeType::fromValue ),
    ...
    public static jolie.runtime.Value toValue( TreeType t ) {
        ...
        t.rest().ifPresent( c -> v.getFirstChild( "rest" ).deepCopy( joliex.meta.spec.types.TreeNodeType.toValue( c ) ) );
    ...
    public static class Builder {
        ...
        private Builder( jolie.runtime.embedding.java.JolieValue j ) {
            ...
            this.basicType = jolie.runtime.embedding.java.util.ValueManager.fieldFrom( j.getFirstChild( "basicType" ), joliex.meta.spec.types.BasicType::from );
            this.rest = jolie.runtime.embedding.java.util.ValueManager.fieldFrom( j.getFirstChild( "rest" ), joliex.meta.spec.types.TreeNodeType::from );
            this.nodes = jolie.runtime.embedding.java.util.ValueManager.fieldFrom( j.getChildOrDefault( "nodes", java.util.List.of() ), joliex.meta.spec.types.TreeNodeType::from );
        ...
        public Builder basicType( joliex.meta.spec.types.BasicType basicType ) { this.basicType = basicType; return this; }
        public Builder rest( joliex.meta.spec.types.TreeNodeType rest ) { this.rest = rest; return this; }
        public Builder rest( java.util.function.Function<joliex.meta.spec.types.TreeNodeType.Builder, joliex.meta.spec.types.TreeNodeType> f ) { return rest( f.apply( joliex.meta.spec.types.TreeNodeType.builder() ) ); }
        public Builder nodes( java.util.SequencedCollection<joliex.meta.spec.types.TreeNodeType> nodes ) { this.nodes = nodes; return this; }
        public Builder nodes( java.util.function.Function<jolie.runtime.embedding.java.util.StructureListBuilder<joliex.meta.spec.types.TreeNodeType, joliex.meta.spec.types.TreeNodeType.Builder>, java.util.List<joliex.meta.spec.types.TreeNodeType>> f ) { return nodes( f.apply( new jolie.runtime.embedding.java.util.StructureListBuilder<>( joliex.meta.spec.types.TreeNodeType::builder ) ) ); }
