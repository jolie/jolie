...
public final class OneWayOperation extends jolie.runtime.embedding.java.TypedStructure {
    ...
    public OneWayOperation( joliex.meta.spec.types.Location textLocation, joliex.meta.spec.types.Type requestType, joliex.meta.spec.types.LocatedString name ) {
    ...
    public static jolie.runtime.embedding.java.util.StructureListBuilder<OneWayOperation, Builder> listBuilder() { return new jolie.runtime.embedding.java.util.StructureListBuilder<>( OneWayOperation::builder ); }
    public static jolie.runtime.embedding.java.util.StructureListBuilder<OneWayOperation, Builder> listBuilder( java.util.SequencedCollection<? extends jolie.runtime.embedding.java.JolieValue> from ) {
        return from != null ? new jolie.runtime.embedding.java.util.StructureListBuilder<>( from, OneWayOperation::from, OneWayOperation::builder ) : listBuilder();
    }
    
    public static OneWayOperation from( jolie.runtime.embedding.java.JolieValue j ) throws jolie.runtime.embedding.java.TypeValidationException {
