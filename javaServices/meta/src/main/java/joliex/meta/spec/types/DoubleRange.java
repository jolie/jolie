...
public final class DoubleRange extends jolie.runtime.embedding.java.TypedStructure {
	...
	public static jolie.runtime.embedding.java.util.StructureListBuilder< DoubleRange, Builder > listBuilder() {
		return new jolie.runtime.embedding.java.util.StructureListBuilder<>( DoubleRange::builder );
	}

	public static jolie.runtime.embedding.java.util.StructureListBuilder< DoubleRange, Builder > listBuilder(
		java.util.SequencedCollection< ? extends jolie.runtime.embedding.java.JolieValue > from ) {
		return from != null
			? new jolie.runtime.embedding.java.util.StructureListBuilder<>( from, DoubleRange::from,
				DoubleRange::builder )
			: listBuilder();
	}

	public static DoubleRange from( jolie.runtime.embedding.java.JolieValue j )
		...
		return new DoubleRange(
			jolie.runtime.embedding.java.util.ValueManager.fieldFrom( j.getFirstChild( "min" ),
				c -> c.content() instanceof jolie.runtime.embedding.java.JolieNative.JolieDouble content
					? content.value()
					: null ),
	...
	public static DoubleRange fromValue( jolie.runtime.Value v ) throws jolie.runtime.typing.TypeCheckingException {
		...
		return new DoubleRange(
			jolie.runtime.embedding.java.util.ValueManager.singleFieldFrom( v, "min",
				jolie.runtime.embedding.java.JolieNative.JolieDouble::fieldFromValue ),
	...
	public static class Builder {
		...
		public Builder min( java.lang.Double min ) {
			this.min = min;
			return this;
		}

		public Builder max( java.lang.Double max ) {
			this.max = max;
			return this;
		}
