...
public final class Aggregation extends jolie.runtime.embedding.java.TypedStructure {
    ...
    public Aggregation( joliex.meta.spec.types.Location textLocation, java.util.SequencedCollection<joliex.meta.spec.types.LocatedSymbolRef> extender, joliex.meta.spec.types.LocatedSymbolRef outputPort ) {
        this.textLocation = jolie.runtime.embedding.java.util.ValueManager.validated( "textLocation", textLocation );
        this.extender = jolie.runtime.embedding.java.util.ValueManager.validated( "extender", extender, 0, 2147483647, t -> t );
    ...
    public java.util.List<joliex.meta.spec.types.LocatedSymbolRef> extender() { return extender; }
    ...
    public static jolie.runtime.embedding.java.util.StructureListBuilder<Aggregation, Builder> listBuilder() { return new jolie.runtime.embedding.java.util.StructureListBuilder<>( Aggregation::builder ); }
    public static jolie.runtime.embedding.java.util.StructureListBuilder<Aggregation, Builder> listBuilder( java.util.SequencedCollection<? extends jolie.runtime.embedding.java.JolieValue> from ) {
        return from != null ? new jolie.runtime.embedding.java.util.StructureListBuilder<>( from, Aggregation::from, Aggregation::builder ) : listBuilder();
    }
    
    public static Aggregation from( jolie.runtime.embedding.java.JolieValue j ) throws jolie.runtime.embedding.java.TypeValidationException {
        return new Aggregation(
            ...
            jolie.runtime.embedding.java.util.ValueManager.fieldFrom( j.getChildOrDefault( "extender", java.util.List.of() ), joliex.meta.spec.types.LocatedSymbolRef::from ),
    ...
    public static Aggregation fromValue( jolie.runtime.Value v ) throws jolie.runtime.typing.TypeCheckingException {
        ...
        return new Aggregation(
            ...
            jolie.runtime.embedding.java.util.ValueManager.vectorFieldFrom( v, "extender", joliex.meta.spec.types.LocatedSymbolRef::fromValue ),
    ...
    public static jolie.runtime.Value toValue( Aggregation t ) {
        ...
        t.extender().forEach( c -> v.getNewChild( "extender" ).deepCopy( joliex.meta.spec.types.LocatedSymbolRef.toValue( c ) ) );
    ...
    public static class Builder {
        ...
        private Builder( jolie.runtime.embedding.java.JolieValue j ) {
            ...
            this.extender = jolie.runtime.embedding.java.util.ValueManager.fieldFrom( j.getChildOrDefault( "extender", java.util.List.of() ), joliex.meta.spec.types.LocatedSymbolRef::from );
        ...
        public Builder extender( java.util.SequencedCollection<joliex.meta.spec.types.LocatedSymbolRef> extender ) { this.extender = extender; return this; }
        public Builder extender( java.util.function.Function<jolie.runtime.embedding.java.util.StructureListBuilder<joliex.meta.spec.types.LocatedSymbolRef, joliex.meta.spec.types.LocatedSymbolRef.Builder>, java.util.List<joliex.meta.spec.types.LocatedSymbolRef>> f ) { return extender( f.apply( new jolie.runtime.embedding.java.util.StructureListBuilder<>( joliex.meta.spec.types.LocatedSymbolRef::builder ) ) ); }
