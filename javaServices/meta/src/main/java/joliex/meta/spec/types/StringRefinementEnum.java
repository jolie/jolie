...
public final class StringRefinementEnum extends jolie.runtime.embedding.java.TypedStructure {
    ...
    public static jolie.runtime.embedding.java.util.StructureListBuilder<StringRefinementEnum, Builder> listBuilder() { return new jolie.runtime.embedding.java.util.StructureListBuilder<>( StringRefinementEnum::builder ); }
    public static jolie.runtime.embedding.java.util.StructureListBuilder<StringRefinementEnum, Builder> listBuilder( java.util.SequencedCollection<? extends jolie.runtime.embedding.java.JolieValue> from ) {
        return from != null ? new jolie.runtime.embedding.java.util.StructureListBuilder<>( from, StringRefinementEnum::from, StringRefinementEnum::builder ) : listBuilder();
    }
    
    public static StringRefinementEnum from( jolie.runtime.embedding.java.JolieValue j ) throws jolie.runtime.embedding.java.TypeValidationException {
    ...
    public static StringRefinementEnum fromValue( jolie.runtime.Value v ) throws jolie.runtime.typing.TypeCheckingException {
