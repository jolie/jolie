...
public final class StringRefinementLength extends jolie.runtime.embedding.java.TypedStructure {
    ...
    public static jolie.runtime.embedding.java.util.StructureListBuilder<StringRefinementLength, Builder> listBuilder() { return new jolie.runtime.embedding.java.util.StructureListBuilder<>( StringRefinementLength::builder ); }
    public static jolie.runtime.embedding.java.util.StructureListBuilder<StringRefinementLength, Builder> listBuilder( java.util.SequencedCollection<? extends jolie.runtime.embedding.java.JolieValue> from ) {
        return from != null ? new jolie.runtime.embedding.java.util.StructureListBuilder<>( from, StringRefinementLength::from, StringRefinementLength::builder ) : listBuilder();
    }
    
    public static StringRefinementLength from( jolie.runtime.embedding.java.JolieValue j ) throws jolie.runtime.embedding.java.TypeValidationException {
    ...
    public static StringRefinementLength fromValue( jolie.runtime.Value v ) throws jolie.runtime.typing.TypeCheckingException {
