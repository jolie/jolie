 ...
 * @see #construct()
 */
public final class UrlEncodeRequest extends ImmutableStructure<JolieString> {
    
    public Optional<String> charset() { return getFirstChildValue( "charset", JolieString.class ); }
    
    private UrlEncodeRequest( Builder<?> builder ) {
    ...
    static <T> NestedBuilder<T> constructNested( Function<UrlEncodeRequest, T> doneFunc ) { return new NestedBuilder<>( doneFunc ); }
    static <T> NestedBuilder<T> constructNested( Function<UrlEncodeRequest, T> doneFunc, JolieValue t ) { return new NestedBuilder<>( doneFunc, t ); }
    
    static InlineListBuilder constructList() { return new InlineListBuilder(); }
    
    static <T> NestedListBuilder<T> constructNestedList( Function<List<UrlEncodeRequest>, T> doneFunc ) { return new NestedListBuilder<>( doneFunc ); }
    static <T> NestedListBuilder<T> constructNestedList( Function<List<UrlEncodeRequest>, T> doneFunc, SequencedCollection<? extends JolieValue> c ) { return new NestedListBuilder<>( doneFunc, c ); }
    
    public static InlineBuilder constructFrom( JolieValue t ) { return new InlineBuilder( t ); }
    
    public static UrlEncodeRequest createFrom( JolieValue t ) throws TypeValidationException { return constructFrom( t ).build(); }
    
    public static Value toValue( UrlEncodeRequest t ) { return JolieValue.toValue( t ); }
    public static UrlEncodeRequest fromValue( Value value ) throws TypeCheckingException { return Builder.buildFrom( value ); }
    ...
    static abstract class Builder<B> extends StructureBuilder<JolieString, B> {
        ...
        protected UrlEncodeRequest validatedBuild() throws TypeValidationException {
            validateChildren( FIELD_MAP );
            
            return new UrlEncodeRequest( this );
        }
        
        private static UrlEncodeRequest buildFrom( Value value ) throws TypeCheckingException {
            InlineBuilder builder = UrlEncodeRequest.construct();
    ...
    public static class InlineBuilder extends Builder<InlineBuilder> {
        ...
        public UrlEncodeRequest build() throws TypeValidationException { return validatedBuild(); }
    }
    
    public static class NestedBuilder<T> extends Builder<NestedBuilder<T>> {
        
        private final Function<UrlEncodeRequest, T> doneFunc;
        
        private NestedBuilder( Function<UrlEncodeRequest, T> doneFunc, JolieValue t ) { super( t ); this.doneFunc = doneFunc; }
        private NestedBuilder( Function<UrlEncodeRequest, T> doneFunc ) { this.doneFunc = doneFunc; }
    ...
    static abstract class ListBuilder<B> extends StructureListBuilder<UrlEncodeRequest, B> {
        
        protected ListBuilder( SequencedCollection<? extends JolieValue> elements ) { super( elements.parallelStream().map( UrlEncodeRequest::createFrom ).toList() ); }
    ...
    public static class InlineListBuilder extends ListBuilder<InlineListBuilder> {
        ...
        public List<UrlEncodeRequest> build() { return super.build(); }
    }
    
    public static class NestedListBuilder<T> extends ListBuilder<NestedListBuilder<T>> {
        
        private final Function<List<UrlEncodeRequest>, T> doneFunc;
        
        private NestedListBuilder( Function<List<UrlEncodeRequest>, T> doneFunc, SequencedCollection<? extends JolieValue> c ) { super( c ); this.doneFunc = doneFunc; }
        private NestedListBuilder( Function<List<UrlEncodeRequest>, T> doneFunc ) { this.doneFunc = doneFunc; }
