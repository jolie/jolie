 ...
 * @see #construct()
 */
public final class UrlEncodeRequest implements JolieValue {
    ...
    public static class Builder {
        ...
        public UrlEncodeRequest build() {
            return new UrlEncodeRequest( contentValue, charset );
        }
    }
    
    public static class ListBuilder extends AbstractListBuilder<ListBuilder, UrlEncodeRequest> {
        
        private ListBuilder() {}
        private ListBuilder( SequencedCollection<? extends JolieValue> c ) { super( c, UrlEncodeRequest::createFrom ); }
        
        protected ListBuilder self() { return this; }
        
        public ListBuilder add( Function<Builder, UrlEncodeRequest> b ) { return add( b.apply( construct() ) ); }
        public ListBuilder set( int index, Function<Builder, UrlEncodeRequest> b ) { return set( index, b.apply( construct() ) ); }
        public ListBuilder reconstruct( int index, Function<Builder, UrlEncodeRequest> b ) { return replace( index, j -> b.apply( constructFrom( j ) ) ); }
    }
}