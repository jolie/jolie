 ...
 * @see #construct()
 */
public final class IndexOfRequest extends ImmutableStructure<JolieString> {
    
    public String word() { return getFirstChildValue( "word", JolieString.class ).get(); }
    
    private IndexOfRequest( Builder<?> builder ) {
    ...
    static <T> NestedBuilder<T> constructNested( Function<IndexOfRequest, T> doneFunc ) { return new NestedBuilder<>( doneFunc ); }
    static <T> NestedBuilder<T> constructNested( Function<IndexOfRequest, T> doneFunc, JolieValue t ) { return new NestedBuilder<>( doneFunc, t ); }
    
    static InlineListBuilder constructList() { return new InlineListBuilder(); }
    
    static <T> NestedListBuilder<T> constructNestedList( Function<List<IndexOfRequest>, T> doneFunc ) { return new NestedListBuilder<>( doneFunc ); }
    static <T> NestedListBuilder<T> constructNestedList( Function<List<IndexOfRequest>, T> doneFunc, SequencedCollection<? extends JolieValue> c ) { return new NestedListBuilder<>( doneFunc, c ); }
    
    public static InlineBuilder constructFrom( JolieValue t ) { return new InlineBuilder( t ); }
    
    public static IndexOfRequest createFrom( JolieValue t ) throws TypeValidationException { return constructFrom( t ).build(); }
    
    public static Value toValue( IndexOfRequest t ) { return JolieValue.toValue( t ); }
    public static IndexOfRequest fromValue( Value value ) throws TypeCheckingException { return Builder.buildFrom( value ); }
    ...
    static abstract class Builder<B> extends StructureBuilder<JolieString, B> {
        ...
        private static final Map<String,FieldManager<?>> FIELD_MAP = Map.of(
            "word", FieldManager.createNative( JolieString::fromValue, JolieString::createFrom )
        );
        ...
        public B setWord( JolieString contentEntry ) { return putAs( "word", contentEntry, JolieValue::create ); }
        public B setWord( String valueEntry ) { return putAs( "word", valueEntry, JolieValue::create ); }
        public B replaceWord( UnaryOperator<String> valueOperator ) { return computeAs( "word", (n,v) -> valueOperator.apply( v ), s -> JolieString.class.cast( s.content() ).value(), JolieValue::create ); }
        
        protected IndexOfRequest validatedBuild() throws TypeValidationException {
            validateChildren( FIELD_MAP );
            
            return new IndexOfRequest( this );
        }
        
        private static IndexOfRequest buildFrom( Value value ) throws TypeCheckingException {
            InlineBuilder builder = IndexOfRequest.construct();
    ...
    public static class InlineBuilder extends Builder<InlineBuilder> {
        ...
        public IndexOfRequest build() throws TypeValidationException { return validatedBuild(); }
    }
    
    public static class NestedBuilder<T> extends Builder<NestedBuilder<T>> {
        
        private final Function<IndexOfRequest, T> doneFunc;
        
        private NestedBuilder( Function<IndexOfRequest, T> doneFunc, JolieValue t ) { super( t ); this.doneFunc = doneFunc; }
        private NestedBuilder( Function<IndexOfRequest, T> doneFunc ) { this.doneFunc = doneFunc; }
    ...
    static abstract class ListBuilder<B> extends StructureListBuilder<IndexOfRequest, B> {
        
        protected ListBuilder( SequencedCollection<? extends JolieValue> elements ) { super( elements.parallelStream().map( IndexOfRequest::createFrom ).toList() ); }
    ...
    public static class InlineListBuilder extends ListBuilder<InlineListBuilder> {
        ...
        public List<IndexOfRequest> build() { return super.build(); }
    }
    
    public static class NestedListBuilder<T> extends ListBuilder<NestedListBuilder<T>> {
        
        private final Function<List<IndexOfRequest>, T> doneFunc;
        
        private NestedListBuilder( Function<List<IndexOfRequest>, T> doneFunc, SequencedCollection<? extends JolieValue> c ) { super( c ); this.doneFunc = doneFunc; }
        private NestedListBuilder( Function<List<IndexOfRequest>, T> doneFunc ) { this.doneFunc = doneFunc; }
