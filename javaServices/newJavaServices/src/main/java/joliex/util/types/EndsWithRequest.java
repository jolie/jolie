 ...
 * @see #construct()
 */
public final class EndsWithRequest extends ImmutableStructure<JolieString> {
    
    public String suffix() { return getFirstChildValue( "suffix", JolieString.class ).get(); }
    
    private EndsWithRequest( Builder<?> builder ) {
    ...
    static <T> NestedBuilder<T> constructNested( Function<EndsWithRequest, T> doneFunc ) { return new NestedBuilder<>( doneFunc ); }
    static <T> NestedBuilder<T> constructNested( Function<EndsWithRequest, T> doneFunc, JolieValue t ) { return new NestedBuilder<>( doneFunc, t ); }
    
    static InlineListBuilder constructList() { return new InlineListBuilder(); }
    
    static <T> NestedListBuilder<T> constructNestedList( Function<List<EndsWithRequest>, T> doneFunc ) { return new NestedListBuilder<>( doneFunc ); }
    static <T> NestedListBuilder<T> constructNestedList( Function<List<EndsWithRequest>, T> doneFunc, SequencedCollection<? extends JolieValue> c ) { return new NestedListBuilder<>( doneFunc, c ); }
    
    public static InlineBuilder constructFrom( JolieValue t ) { return new InlineBuilder( t ); }
    
    public static EndsWithRequest createFrom( JolieValue t ) throws TypeValidationException { return constructFrom( t ).build(); }
    
    public static Value toValue( EndsWithRequest t ) { return JolieValue.toValue( t ); }
    public static EndsWithRequest fromValue( Value value ) throws TypeCheckingException { return Builder.buildFrom( value ); }
    ...
    static abstract class Builder<B> extends StructureBuilder<JolieString, B> {
        ...
        private static final Map<String,FieldManager<?>> FIELD_MAP = Map.of(
            "suffix", FieldManager.createNative( JolieString::fromValue, JolieString::createFrom )
        );
        ...
        public B setSuffix( JolieString contentEntry ) { return putAs( "suffix", contentEntry, JolieValue::create ); }
        public B setSuffix( String valueEntry ) { return putAs( "suffix", valueEntry, JolieValue::create ); }
        public B replaceSuffix( UnaryOperator<String> valueOperator ) { return computeAs( "suffix", (n,v) -> valueOperator.apply( v ), s -> JolieString.class.cast( s.content() ).value(), JolieValue::create ); }
        
        protected EndsWithRequest validatedBuild() throws TypeValidationException {
            validateChildren( FIELD_MAP );
            
            return new EndsWithRequest( this );
        }
        
        private static EndsWithRequest buildFrom( Value value ) throws TypeCheckingException {
            InlineBuilder builder = EndsWithRequest.construct();
    ...
    public static class InlineBuilder extends Builder<InlineBuilder> {
        ...
        public EndsWithRequest build() throws TypeValidationException { return validatedBuild(); }
    }
    
    public static class NestedBuilder<T> extends Builder<NestedBuilder<T>> {
        
        private final Function<EndsWithRequest, T> doneFunc;
        
        private NestedBuilder( Function<EndsWithRequest, T> doneFunc, JolieValue t ) { super( t ); this.doneFunc = doneFunc; }
        private NestedBuilder( Function<EndsWithRequest, T> doneFunc ) { this.doneFunc = doneFunc; }
    ...
    static abstract class ListBuilder<B> extends StructureListBuilder<EndsWithRequest, B> {
        
        protected ListBuilder( SequencedCollection<? extends JolieValue> elements ) { super( elements.parallelStream().map( EndsWithRequest::createFrom ).toList() ); }
    ...
    public static class InlineListBuilder extends ListBuilder<InlineListBuilder> {
        ...
        public List<EndsWithRequest> build() { return super.build(); }
    }
    
    public static class NestedListBuilder<T> extends ListBuilder<NestedListBuilder<T>> {
        
        private final Function<List<EndsWithRequest>, T> doneFunc;
        
        private NestedListBuilder( Function<List<EndsWithRequest>, T> doneFunc, SequencedCollection<? extends JolieValue> c ) { super( c ); this.doneFunc = doneFunc; }
        private NestedListBuilder( Function<List<EndsWithRequest>, T> doneFunc ) { this.doneFunc = doneFunc; }
