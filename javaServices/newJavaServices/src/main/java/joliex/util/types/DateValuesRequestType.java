 ...
 * @see #construct()
 */
public final class DateValuesRequestType extends ImmutableStructure<JolieString> {
    
    public Optional<String> format() { return getFirstChildValue( "format", JolieString.class ); }
    
    private DateValuesRequestType( Builder<?> builder ) {
    ...
    static <T> NestedBuilder<T> constructNested( Function<DateValuesRequestType, T> doneFunc ) { return new NestedBuilder<>( doneFunc ); }
    static <T> NestedBuilder<T> constructNested( Function<DateValuesRequestType, T> doneFunc, JolieValue t ) { return new NestedBuilder<>( doneFunc, t ); }
    
    static InlineListBuilder constructList() { return new InlineListBuilder(); }
    
    static <T> NestedListBuilder<T> constructNestedList( Function<List<DateValuesRequestType>, T> doneFunc ) { return new NestedListBuilder<>( doneFunc ); }
    static <T> NestedListBuilder<T> constructNestedList( Function<List<DateValuesRequestType>, T> doneFunc, SequencedCollection<? extends JolieValue> c ) { return new NestedListBuilder<>( doneFunc, c ); }
    
    public static InlineBuilder constructFrom( JolieValue t ) { return new InlineBuilder( t ); }
    
    public static DateValuesRequestType createFrom( JolieValue t ) throws TypeValidationException { return constructFrom( t ).build(); }
    
    public static Value toValue( DateValuesRequestType t ) { return JolieValue.toValue( t ); }
    public static DateValuesRequestType fromValue( Value value ) throws TypeCheckingException { return Builder.buildFrom( value ); }
    ...
    static abstract class Builder<B> extends StructureBuilder<JolieString, B> {
        ...
        protected DateValuesRequestType validatedBuild() throws TypeValidationException {
            validateChildren( FIELD_MAP );
            
            return new DateValuesRequestType( this );
        }
        
        private static DateValuesRequestType buildFrom( Value value ) throws TypeCheckingException {
            InlineBuilder builder = DateValuesRequestType.construct();
    ...
    public static class InlineBuilder extends Builder<InlineBuilder> {
        ...
        public DateValuesRequestType build() throws TypeValidationException { return validatedBuild(); }
    }
    
    public static class NestedBuilder<T> extends Builder<NestedBuilder<T>> {
        
        private final Function<DateValuesRequestType, T> doneFunc;
        
        private NestedBuilder( Function<DateValuesRequestType, T> doneFunc, JolieValue t ) { super( t ); this.doneFunc = doneFunc; }
        private NestedBuilder( Function<DateValuesRequestType, T> doneFunc ) { this.doneFunc = doneFunc; }
    ...
    static abstract class ListBuilder<B> extends StructureListBuilder<DateValuesRequestType, B> {
        
        protected ListBuilder( SequencedCollection<? extends JolieValue> elements ) { super( elements.parallelStream().map( DateValuesRequestType::createFrom ).toList() ); }
    ...
    public static class InlineListBuilder extends ListBuilder<InlineListBuilder> {
        ...
        public List<DateValuesRequestType> build() { return super.build(); }
    }
    
    public static class NestedListBuilder<T> extends ListBuilder<NestedListBuilder<T>> {
        
        private final Function<List<DateValuesRequestType>, T> doneFunc;
        
        private NestedListBuilder( Function<List<DateValuesRequestType>, T> doneFunc, SequencedCollection<? extends JolieValue> c ) { super( c ); this.doneFunc = doneFunc; }
        private NestedListBuilder( Function<List<DateValuesRequestType>, T> doneFunc ) { this.doneFunc = doneFunc; }
