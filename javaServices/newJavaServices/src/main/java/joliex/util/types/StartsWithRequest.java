 ...
 * @see #construct()
 */
public final class StartsWithRequest extends ImmutableStructure<JolieString> {
    
    public String prefix() { return getFirstChildValue( "prefix", JolieString.class ).get(); }
    
    private StartsWithRequest( Builder<?> builder ) {
    ...
    static <T> NestedBuilder<T> constructNested( Function<StartsWithRequest, T> doneFunc ) { return new NestedBuilder<>( doneFunc ); }
    static <T> NestedBuilder<T> constructNested( Function<StartsWithRequest, T> doneFunc, JolieValue t ) { return new NestedBuilder<>( doneFunc, t ); }
    
    static InlineListBuilder constructList() { return new InlineListBuilder(); }
    
    static <T> NestedListBuilder<T> constructNestedList( Function<List<StartsWithRequest>, T> doneFunc ) { return new NestedListBuilder<>( doneFunc ); }
    static <T> NestedListBuilder<T> constructNestedList( Function<List<StartsWithRequest>, T> doneFunc, SequencedCollection<? extends JolieValue> c ) { return new NestedListBuilder<>( doneFunc, c ); }
    
    public static InlineBuilder constructFrom( JolieValue t ) { return new InlineBuilder( t ); }
    
    public static StartsWithRequest createFrom( JolieValue t ) throws TypeValidationException { return constructFrom( t ).build(); }
    
    public static Value toValue( StartsWithRequest t ) { return JolieValue.toValue( t ); }
    public static StartsWithRequest fromValue( Value value ) throws TypeCheckingException { return Builder.buildFrom( value ); }
    ...
    static abstract class Builder<B> extends StructureBuilder<JolieString, B> {
        ...
        private static final Map<String,FieldManager<?>> FIELD_MAP = Map.of(
            "prefix", FieldManager.createNative( JolieString::fromValue, JolieString::createFrom )
        );
        ...
        public B setPrefix( JolieString contentEntry ) { return putAs( "prefix", contentEntry, JolieValue::create ); }
        public B setPrefix( String valueEntry ) { return putAs( "prefix", valueEntry, JolieValue::create ); }
        public B replacePrefix( UnaryOperator<String> valueOperator ) { return computeAs( "prefix", (n,v) -> valueOperator.apply( v ), s -> JolieString.class.cast( s.content() ).value(), JolieValue::create ); }
        
        protected StartsWithRequest validatedBuild() throws TypeValidationException {
            validateChildren( FIELD_MAP );
            
            return new StartsWithRequest( this );
        }
        
        private static StartsWithRequest buildFrom( Value value ) throws TypeCheckingException {
            InlineBuilder builder = StartsWithRequest.construct();
    ...
    public static class InlineBuilder extends Builder<InlineBuilder> {
        ...
        public StartsWithRequest build() throws TypeValidationException { return validatedBuild(); }
    }
    
    public static class NestedBuilder<T> extends Builder<NestedBuilder<T>> {
        
        private final Function<StartsWithRequest, T> doneFunc;
        
        private NestedBuilder( Function<StartsWithRequest, T> doneFunc, JolieValue t ) { super( t ); this.doneFunc = doneFunc; }
        private NestedBuilder( Function<StartsWithRequest, T> doneFunc ) { this.doneFunc = doneFunc; }
    ...
    static abstract class ListBuilder<B> extends StructureListBuilder<StartsWithRequest, B> {
        
        protected ListBuilder( SequencedCollection<? extends JolieValue> elements ) { super( elements.parallelStream().map( StartsWithRequest::createFrom ).toList() ); }
    ...
    public static class InlineListBuilder extends ListBuilder<InlineListBuilder> {
        ...
        public List<StartsWithRequest> build() { return super.build(); }
    }
    
    public static class NestedListBuilder<T> extends ListBuilder<NestedListBuilder<T>> {
        
        private final Function<List<StartsWithRequest>, T> doneFunc;
        
        private NestedListBuilder( Function<List<StartsWithRequest>, T> doneFunc, SequencedCollection<? extends JolieValue> c ) { super( c ); this.doneFunc = doneFunc; }
        private NestedListBuilder( Function<List<StartsWithRequest>, T> doneFunc ) { this.doneFunc = doneFunc; }
