 ...
 * @see #construct()
 */
public final class UrlDecodeRequest extends ImmutableStructure<JolieString> {
    
    public Optional<String> charset() { return getFirstChildValue( "charset", JolieString.class ); }
    
    private UrlDecodeRequest( Builder<?> builder ) {
    ...
    static <T> NestedBuilder<T> constructNested( Function<UrlDecodeRequest, T> doneFunc ) { return new NestedBuilder<>( doneFunc ); }
    static <T> NestedBuilder<T> constructNested( Function<UrlDecodeRequest, T> doneFunc, JolieValue t ) { return new NestedBuilder<>( doneFunc, t ); }
    
    static InlineListBuilder constructList() { return new InlineListBuilder(); }
    
    static <T> NestedListBuilder<T> constructNestedList( Function<List<UrlDecodeRequest>, T> doneFunc ) { return new NestedListBuilder<>( doneFunc ); }
    static <T> NestedListBuilder<T> constructNestedList( Function<List<UrlDecodeRequest>, T> doneFunc, SequencedCollection<? extends JolieValue> c ) { return new NestedListBuilder<>( doneFunc, c ); }
    
    public static InlineBuilder constructFrom( JolieValue t ) { return new InlineBuilder( t ); }
    
    public static UrlDecodeRequest createFrom( JolieValue t ) throws TypeValidationException { return constructFrom( t ).build(); }
    
    public static Value toValue( UrlDecodeRequest t ) { return JolieValue.toValue( t ); }
    public static UrlDecodeRequest fromValue( Value value ) throws TypeCheckingException { return Builder.buildFrom( value ); }
    ...
    static abstract class Builder<B> extends StructureBuilder<JolieString, B> {
        ...
        private static final Map<String,FieldManager<?>> FIELD_MAP = Map.of(
            "charset", FieldManager.createNative( 0, 1, JolieString::fromValue, JolieString::createFrom )
        );
        ...
        public B setCharset( JolieString contentEntry ) { return putAs( "charset", contentEntry, JolieValue::create ); }
        public B setCharset( String valueEntry ) { return putAs( "charset", valueEntry, JolieValue::create ); }
        public B replaceCharset( UnaryOperator<String> valueOperator ) { return computeAs( "charset", (n,v) -> valueOperator.apply( v ), s -> JolieString.class.cast( s.content() ).value(), JolieValue::create ); }
        
        protected UrlDecodeRequest validatedBuild() throws TypeValidationException {
            validateChildren( FIELD_MAP );
            
            return new UrlDecodeRequest( this );
        }
        
        private static UrlDecodeRequest buildFrom( Value value ) throws TypeCheckingException {
            InlineBuilder builder = UrlDecodeRequest.construct();
    ...
    public static class InlineBuilder extends Builder<InlineBuilder> {
        ...
        public UrlDecodeRequest build() throws TypeValidationException { return validatedBuild(); }
    }
    
    public static class NestedBuilder<T> extends Builder<NestedBuilder<T>> {
        
        private final Function<UrlDecodeRequest, T> doneFunc;
        
        private NestedBuilder( Function<UrlDecodeRequest, T> doneFunc, JolieValue t ) { super( t ); this.doneFunc = doneFunc; }
        private NestedBuilder( Function<UrlDecodeRequest, T> doneFunc ) { this.doneFunc = doneFunc; }
    ...
    static abstract class ListBuilder<B> extends StructureListBuilder<UrlDecodeRequest, B> {
        
        protected ListBuilder( SequencedCollection<? extends JolieValue> elements ) { super( elements.parallelStream().map( UrlDecodeRequest::createFrom ).toList() ); }
    ...
    public static class InlineListBuilder extends ListBuilder<InlineListBuilder> {
        ...
        public List<UrlDecodeRequest> build() { return super.build(); }
    }
    
    public static class NestedListBuilder<T> extends ListBuilder<NestedListBuilder<T>> {
        
        private final Function<List<UrlDecodeRequest>, T> doneFunc;
        
        private NestedListBuilder( Function<List<UrlDecodeRequest>, T> doneFunc, SequencedCollection<? extends JolieValue> c ) { super( c ); this.doneFunc = doneFunc; }
        private NestedListBuilder( Function<List<UrlDecodeRequest>, T> doneFunc ) { this.doneFunc = doneFunc; }
