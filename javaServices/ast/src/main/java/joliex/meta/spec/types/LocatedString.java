 ...
 * @see #builder()
 */
public final class LocatedString extends jolie.runtime.embedding.java.TypedStructure {
    
    private static final java.util.Set<java.lang.String> FIELD_KEYS = fieldKeys( LocatedString.class );
    ...
    public LocatedString( java.lang.String contentValue, joliex.meta.spec.types.Location textLocation ) {
    ...
    public static jolie.runtime.embedding.java.util.StructureListBuilder<LocatedString, Builder> listBuilder() { return new jolie.runtime.embedding.java.util.StructureListBuilder<>( LocatedString::builder ); }
    public static jolie.runtime.embedding.java.util.StructureListBuilder<LocatedString, Builder> listBuilder( java.util.SequencedCollection<? extends jolie.runtime.embedding.java.JolieValue> from ) {
        return from != null ? new jolie.runtime.embedding.java.util.StructureListBuilder<>( from, LocatedString::from, LocatedString::builder ) : listBuilder();
    }
    
    public static LocatedString from( jolie.runtime.embedding.java.JolieValue j ) throws jolie.runtime.embedding.java.TypeValidationException {
    ...
    public static LocatedString fromValue( jolie.runtime.Value v ) throws jolie.runtime.typing.TypeCheckingException {
    ...
    public static jolie.runtime.Value toValue( LocatedString t ) {
    ...
    public static class Builder {
        ...
        public LocatedString build() {
            return new LocatedString( contentValue, textLocation );
        }
    }
}