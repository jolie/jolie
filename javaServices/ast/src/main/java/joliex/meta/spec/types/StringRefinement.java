...
public sealed interface StringRefinement extends jolie.runtime.embedding.java.JolieValue {
     ...
     * this class is a {@link jolie.runtime.embedding.java.TypedStructure} which can be described as follows:
     * <pre>
     * enumeration("enum")[1,2147483647]: {@link java.lang.String}
     * </pre>
     * 
     * @see jolie.runtime.embedding.java.JolieValue
     * @see jolie.runtime.embedding.java.JolieNative
    ...
    public static final class S2 extends jolie.runtime.embedding.java.TypedStructure {
        ...
        private final java.util.List<java.lang.String> enumeration;
        
        public S2( java.util.SequencedCollection<java.lang.String> enumeration ) {
            this.enumeration = jolie.runtime.embedding.java.util.ValueManager.validated( "enumeration", enumeration, 1, 2147483647, t -> t );
        }
        
        public java.util.List<java.lang.String> enumeration() { return enumeration; }
        ...
        public static jolie.runtime.Value toValue( S2 t ) {
            ...
            t.enumeration().forEach( c -> v.getNewChild( "enum" ).setValue( c ) );
        ...
        public static class Builder {
            ...
            private java.util.SequencedCollection<java.lang.String> enumeration;
            
            private Builder() {}
            private Builder( jolie.runtime.embedding.java.JolieValue j ) {
                this.enumeration = jolie.runtime.embedding.java.util.ValueManager.fieldFrom( j.getChildOrDefault( "enum", java.util.List.of() ), c -> c.content() instanceof jolie.runtime.embedding.java.JolieNative.JolieString content ? content.value() : null );
            }
            
            public Builder enumeration( java.util.SequencedCollection<java.lang.String> enumeration ) { this.enumeration = enumeration; return this; }
            public Builder enumeration( java.lang.String... values ) { return enumeration( values == null ? null : java.util.List.of( values ) ); }
            
            public S2 build() {
                return new S2( enumeration );
            }
        }
    }
