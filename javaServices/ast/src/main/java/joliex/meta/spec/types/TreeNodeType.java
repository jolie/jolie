...
public final class TreeNodeType extends jolie.runtime.embedding.java.TypedStructure {
    ...
    public TreeNodeType( joliex.meta.spec.types.Location textLocation, joliex.meta.spec.types.Documentation documentation, joliex.meta.spec.types.LocatedString name, joliex.meta.spec.types.NonNegativeIntRange range, joliex.meta.spec.types.Type type ) {
    ...
    public joliex.meta.spec.types.NonNegativeIntRange range() { return range; }
    public joliex.meta.spec.types.Type type() { return type; }
    ...
    public static jolie.runtime.embedding.java.util.StructureListBuilder<TreeNodeType, Builder> listBuilder() { return new jolie.runtime.embedding.java.util.StructureListBuilder<>( TreeNodeType::builder ); }
    public static jolie.runtime.embedding.java.util.StructureListBuilder<TreeNodeType, Builder> listBuilder( java.util.SequencedCollection<? extends jolie.runtime.embedding.java.JolieValue> from ) {
        return from != null ? new jolie.runtime.embedding.java.util.StructureListBuilder<>( from, TreeNodeType::from, TreeNodeType::builder ) : listBuilder();
    }
    
    public static TreeNodeType from( jolie.runtime.embedding.java.JolieValue j ) throws jolie.runtime.embedding.java.TypeValidationException {
        return new TreeNodeType(
            ...
            jolie.runtime.embedding.java.util.ValueManager.fieldFrom( j.getFirstChild( "range" ), joliex.meta.spec.types.NonNegativeIntRange::from ),
            jolie.runtime.embedding.java.util.ValueManager.fieldFrom( j.getFirstChild( "type" ), joliex.meta.spec.types.Type::from )
        );
    }
    ...
    public static TreeNodeType fromValue( jolie.runtime.Value v ) throws jolie.runtime.typing.TypeCheckingException {
        ...
        return new TreeNodeType(
            ...
            jolie.runtime.embedding.java.util.ValueManager.singleFieldFrom( v, "range", joliex.meta.spec.types.NonNegativeIntRange::fromValue ),
            jolie.runtime.embedding.java.util.ValueManager.singleFieldFrom( v, "type", joliex.meta.spec.types.Type::fromValue )
        );
    }
    ...
    public static class Builder {
        ...
        private Builder( jolie.runtime.embedding.java.JolieValue j ) {
            ...
            this.range = jolie.runtime.embedding.java.util.ValueManager.fieldFrom( j.getFirstChild( "range" ), joliex.meta.spec.types.NonNegativeIntRange::from );
            this.type = jolie.runtime.embedding.java.util.ValueManager.fieldFrom( j.getFirstChild( "type" ), joliex.meta.spec.types.Type::from );
        }
        ...
        public Builder range( joliex.meta.spec.types.NonNegativeIntRange range ) { this.range = range; return this; }
        public Builder range( java.util.function.Function<joliex.meta.spec.types.NonNegativeIntRange.Builder, joliex.meta.spec.types.NonNegativeIntRange> f ) { return range( f.apply( joliex.meta.spec.types.NonNegativeIntRange.builder() ) ); }
        public Builder type( joliex.meta.spec.types.Type type ) { this.type = type; return this; }
