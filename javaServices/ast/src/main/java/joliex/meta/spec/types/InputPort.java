...
public final class InputPort extends jolie.runtime.embedding.java.TypedStructure {
    ...
    public InputPort( joliex.meta.spec.types.Location textLocation, java.util.SequencedCollection<joliex.meta.spec.types.Redirection> redirections, joliex.meta.spec.types.LocatedString protocol, java.util.SequencedCollection<java.lang.String> interfaces, java.util.SequencedCollection<joliex.meta.spec.types.Operation> operations, joliex.meta.spec.types.LocatedString name, joliex.meta.spec.types.LocatedString location, java.util.SequencedCollection<joliex.meta.spec.types.Aggregation> aggregations ) {
        this.textLocation = jolie.runtime.embedding.java.util.ValueManager.validated( "textLocation", textLocation );
        this.redirections = jolie.runtime.embedding.java.util.ValueManager.validated( "redirections", redirections, 0, 2147483647, t -> t );
        ...
        this.aggregations = jolie.runtime.embedding.java.util.ValueManager.validated( "aggregations", aggregations, 0, 2147483647, t -> t );
    }
    
    public joliex.meta.spec.types.Location textLocation() { return textLocation; }
    public java.util.List<joliex.meta.spec.types.Redirection> redirections() { return redirections; }
    ...
    public java.util.List<joliex.meta.spec.types.Aggregation> aggregations() { return aggregations; }
    ...
    public static jolie.runtime.embedding.java.util.StructureListBuilder<InputPort, Builder> listBuilder() { return new jolie.runtime.embedding.java.util.StructureListBuilder<>( InputPort::builder ); }
    public static jolie.runtime.embedding.java.util.StructureListBuilder<InputPort, Builder> listBuilder( java.util.SequencedCollection<? extends jolie.runtime.embedding.java.JolieValue> from ) {
        return from != null ? new jolie.runtime.embedding.java.util.StructureListBuilder<>( from, InputPort::from, InputPort::builder ) : listBuilder();
    }
    
    public static InputPort from( jolie.runtime.embedding.java.JolieValue j ) throws jolie.runtime.embedding.java.TypeValidationException {
        return new InputPort(
            ...
            jolie.runtime.embedding.java.util.ValueManager.fieldFrom( j.getChildOrDefault( "redirections", java.util.List.of() ), joliex.meta.spec.types.Redirection::from ),
            ...
            jolie.runtime.embedding.java.util.ValueManager.fieldFrom( j.getChildOrDefault( "aggregations", java.util.List.of() ), joliex.meta.spec.types.Aggregation::from )
        );
    }
    ...
    public static InputPort fromValue( jolie.runtime.Value v ) throws jolie.runtime.typing.TypeCheckingException {
        ...
        return new InputPort(
            ...
            jolie.runtime.embedding.java.util.ValueManager.vectorFieldFrom( v, "redirections", joliex.meta.spec.types.Redirection::fromValue ),
            ...
            jolie.runtime.embedding.java.util.ValueManager.vectorFieldFrom( v, "aggregations", joliex.meta.spec.types.Aggregation::fromValue )
        );
    }
    ...
    public static jolie.runtime.Value toValue( InputPort t ) {
        ...
        t.redirections().forEach( c -> v.getNewChild( "redirections" ).deepCopy( joliex.meta.spec.types.Redirection.toValue( c ) ) );
        ...
        t.aggregations().forEach( c -> v.getNewChild( "aggregations" ).deepCopy( joliex.meta.spec.types.Aggregation.toValue( c ) ) );
    ...
    public static class Builder {
        ...
        private Builder( jolie.runtime.embedding.java.JolieValue j ) {
            ...
            this.redirections = jolie.runtime.embedding.java.util.ValueManager.fieldFrom( j.getChildOrDefault( "redirections", java.util.List.of() ), joliex.meta.spec.types.Redirection::from );
            ...
            this.aggregations = jolie.runtime.embedding.java.util.ValueManager.fieldFrom( j.getChildOrDefault( "aggregations", java.util.List.of() ), joliex.meta.spec.types.Aggregation::from );
        }
        ...
        public Builder redirections( java.util.SequencedCollection<joliex.meta.spec.types.Redirection> redirections ) { this.redirections = redirections; return this; }
        public Builder redirections( java.util.function.Function<jolie.runtime.embedding.java.util.StructureListBuilder<joliex.meta.spec.types.Redirection, joliex.meta.spec.types.Redirection.Builder>, java.util.List<joliex.meta.spec.types.Redirection>> f ) { return redirections( f.apply( new jolie.runtime.embedding.java.util.StructureListBuilder<>( joliex.meta.spec.types.Redirection::builder ) ) ); }
        ...
        public Builder aggregations( java.util.SequencedCollection<joliex.meta.spec.types.Aggregation> aggregations ) { this.aggregations = aggregations; return this; }
        public Builder aggregations( java.util.function.Function<jolie.runtime.embedding.java.util.StructureListBuilder<joliex.meta.spec.types.Aggregation, joliex.meta.spec.types.Aggregation.Builder>, java.util.List<joliex.meta.spec.types.Aggregation>> f ) { return aggregations( f.apply( new jolie.runtime.embedding.java.util.StructureListBuilder<>( joliex.meta.spec.types.Aggregation::builder ) ) ); }
        
        public InputPort build() {
            return new InputPort( textLocation, redirections, protocol, interfaces, operations, name, location, aggregations );
        }
    }
}