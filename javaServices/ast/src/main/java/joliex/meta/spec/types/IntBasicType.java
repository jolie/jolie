...
public final class IntBasicType extends jolie.runtime.embedding.java.TypedStructure {
    ...
    public IntBasicType( jolie.runtime.embedding.java.JolieNative.JolieVoid intTag, java.util.SequencedCollection<joliex.meta.spec.types.IntRefinement> refinements ) {
    ...
    public jolie.runtime.embedding.java.JolieNative.JolieVoid intTag() { return intTag; }
    ...
    public static class Builder {
        ...
        private Builder( jolie.runtime.embedding.java.JolieValue j ) {
            this.intTag = jolie.runtime.embedding.java.util.ValueManager.fieldFrom( j.getFirstChild( "int" ), c -> c.content() instanceof jolie.runtime.embedding.java.JolieNative.JolieVoid content ? content : null );
        ...
        public Builder intTag( jolie.runtime.embedding.java.JolieNative.JolieVoid intTag ) { this.intTag = intTag; return this; }
