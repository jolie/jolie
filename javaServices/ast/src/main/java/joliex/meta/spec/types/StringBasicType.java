...
public final class StringBasicType extends jolie.runtime.embedding.java.TypedStructure {
    ...
    public StringBasicType( jolie.runtime.embedding.java.JolieNative.JolieVoid stringTag, java.util.SequencedCollection<joliex.meta.spec.types.StringRefinement> refinements ) {
    ...
    public jolie.runtime.embedding.java.JolieNative.JolieVoid stringTag() { return stringTag; }
    ...
    public static class Builder {
        ...
        private Builder( jolie.runtime.embedding.java.JolieValue j ) {
            this.stringTag = jolie.runtime.embedding.java.util.ValueManager.fieldFrom( j.getFirstChild( "string" ), c -> c.content() instanceof jolie.runtime.embedding.java.JolieNative.JolieVoid content ? content : null );
        ...
        public Builder stringTag( jolie.runtime.embedding.java.JolieNative.JolieVoid stringTag ) { this.stringTag = stringTag; return this; }
