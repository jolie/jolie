...
public final class LocatedSymbolRef extends jolie.runtime.embedding.java.TypedStructure {
    ...
    public static jolie.runtime.embedding.java.util.StructureListBuilder<LocatedSymbolRef, Builder> listBuilder() { return new jolie.runtime.embedding.java.util.StructureListBuilder<>( LocatedSymbolRef::builder ); }
    public static jolie.runtime.embedding.java.util.StructureListBuilder<LocatedSymbolRef, Builder> listBuilder( java.util.SequencedCollection<? extends jolie.runtime.embedding.java.JolieValue> from ) {
        return from != null ? new jolie.runtime.embedding.java.util.StructureListBuilder<>( from, LocatedSymbolRef::from, LocatedSymbolRef::builder ) : listBuilder();
    }
    
    public static LocatedSymbolRef from( jolie.runtime.embedding.java.JolieValue j ) throws jolie.runtime.embedding.java.TypeValidationException {
    ...
    public static LocatedSymbolRef fromValue( jolie.runtime.Value v ) throws jolie.runtime.typing.TypeCheckingException {
