...
public final class DoubleBasicType extends jolie.runtime.embedding.java.TypedStructure {
	...
	public DoubleBasicType( jolie.runtime.embedding.java.JolieNative.JolieVoid doubleTag,
		java.util.SequencedCollection< joliex.meta.spec.types.DoubleRefinement > refinements ) {
	...
	public jolie.runtime.embedding.java.JolieNative.JolieVoid doubleTag() {
		return doubleTag;
	}

	public java.util.List< joliex.meta.spec.types.DoubleRefinement > refinements() {
		return refinements;
	}
	...
	public static jolie.runtime.embedding.java.util.StructureListBuilder< DoubleBasicType, Builder > listBuilder() {
		return new jolie.runtime.embedding.java.util.StructureListBuilder<>( DoubleBasicType::builder );
	}

	public static jolie.runtime.embedding.java.util.StructureListBuilder< DoubleBasicType, Builder > listBuilder(
		java.util.SequencedCollection< ? extends jolie.runtime.embedding.java.JolieValue > from ) {
		return from != null
			? new jolie.runtime.embedding.java.util.StructureListBuilder<>( from, DoubleBasicType::from,
				DoubleBasicType::builder )
			: listBuilder();
	}

	public static DoubleBasicType from( jolie.runtime.embedding.java.JolieValue j )
		throws jolie.runtime.embedding.java.TypeValidationException {
		return new DoubleBasicType(
			jolie.runtime.embedding.java.util.ValueManager.fieldFrom( j.getFirstChild( "double" ),
			...
			jolie.runtime.embedding.java.util.ValueManager.fieldFrom(
				...
				joliex.meta.spec.types.DoubleRefinement::from ) );
	}
	...
	public static DoubleBasicType fromValue( jolie.runtime.Value v ) throws jolie.runtime.typing.TypeCheckingException {
		...
		return new DoubleBasicType(
			jolie.runtime.embedding.java.util.ValueManager.singleFieldFrom( v, "double",
			...
			jolie.runtime.embedding.java.util.ValueManager.vectorFieldFrom( v, "refinements",
				joliex.meta.spec.types.DoubleRefinement::fromValue ) );
	}
	...
	public static jolie.runtime.Value toValue( DoubleBasicType t ) {
		...
		t.refinements().forEach(
			c -> v.getNewChild( "refinements" ).deepCopy( joliex.meta.spec.types.DoubleRefinement.toValue( c ) ) );
	...
	public static class Builder {
		...
		private Builder( jolie.runtime.embedding.java.JolieValue j ) {
			this.doubleTag = jolie.runtime.embedding.java.util.ValueManager.fieldFrom( j.getFirstChild( "double" ),
				c -> c.content() instanceof jolie.runtime.embedding.java.JolieNative.JolieVoid content ? content
					: null );
		...
		public Builder doubleTag( jolie.runtime.embedding.java.JolieNative.JolieVoid doubleTag ) {
		...
		public Builder refinements(
			java.util.function.Function< jolie.runtime.embedding.java.util.StructureListBuilder< joliex.meta.spec.types.DoubleRefinement, joliex.meta.spec.types.DoubleRefinement.Builder >, java.util.List< joliex.meta.spec.types.DoubleRefinement > > f ) {
