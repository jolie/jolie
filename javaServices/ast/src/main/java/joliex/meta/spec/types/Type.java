...
public sealed interface Type extends jolie.runtime.embedding.java.JolieValue {
    ...
    public static Type of1( S1 option ) { return new C1( option ); }
    public static Type of1( java.util.function.Function<S1.Builder, S1> f ) { return of1( f.apply( S1.builder() ) ); }
    
    public static Type of2( S2 option ) { return new C2( option ); }
    public static Type of2( java.util.function.Function<S2.Builder, S2> f ) { return of2( f.apply( S2.builder() ) ); }
    
    public static Type of3( S3 option ) { return new C3( option ); }
    public static Type of3( java.util.function.Function<S3.Builder, S3> f ) { return of3( f.apply( S3.builder() ) ); }
    
    public static Type from( jolie.runtime.embedding.java.JolieValue j ) throws jolie.runtime.embedding.java.TypeValidationException {
    ...
    public static jolie.runtime.Value toValue( Type t ) { return t.jolieRepr(); }
    ...
    public static final class S1 extends jolie.runtime.embedding.java.TypedStructure {
        ...
        public joliex.meta.spec.types.TreeType tree() { return tree; }
        ...
        public static S1 from( jolie.runtime.embedding.java.JolieValue j ) throws jolie.runtime.embedding.java.TypeValidationException {
            return new S1(
                jolie.runtime.embedding.java.util.ValueManager.fieldFrom( j.getFirstChild( "tree" ), joliex.meta.spec.types.TreeType::from )
            );
        }
        ...
        public static S1 fromValue( jolie.runtime.Value v ) throws jolie.runtime.typing.TypeCheckingException {
            ...
            return new S1(
                jolie.runtime.embedding.java.util.ValueManager.singleFieldFrom( v, "tree", joliex.meta.spec.types.TreeType::fromValue )
            );
        }
        ...
        public static class Builder {
            ...
            private Builder( jolie.runtime.embedding.java.JolieValue j ) {
                this.tree = jolie.runtime.embedding.java.util.ValueManager.fieldFrom( j.getFirstChild( "tree" ), joliex.meta.spec.types.TreeType::from );
            }
            
            public Builder tree( joliex.meta.spec.types.TreeType tree ) { this.tree = tree; return this; }
            public Builder tree( java.util.function.Function<joliex.meta.spec.types.TreeType.Builder, joliex.meta.spec.types.TreeType> f ) { return tree( f.apply( joliex.meta.spec.types.TreeType.builder() ) ); }
    ...
    public static final class S2 extends jolie.runtime.embedding.java.TypedStructure {
        ...
        public joliex.meta.spec.types.ChoiceType choice() { return choice; }
        ...
        public static S2 from( jolie.runtime.embedding.java.JolieValue j ) throws jolie.runtime.embedding.java.TypeValidationException {
            return new S2(
                jolie.runtime.embedding.java.util.ValueManager.fieldFrom( j.getFirstChild( "choice" ), joliex.meta.spec.types.ChoiceType::from )
            );
        }
        ...
        public static S2 fromValue( jolie.runtime.Value v ) throws jolie.runtime.typing.TypeCheckingException {
            jolie.runtime.embedding.java.util.ValueManager.requireChildren( v, FIELD_KEYS );
            return new S2(
                jolie.runtime.embedding.java.util.ValueManager.singleFieldFrom( v, "choice", joliex.meta.spec.types.ChoiceType::fromValue )
            );
        }
        ...
        public static class Builder {
            ...
            private Builder() {}
            private Builder( jolie.runtime.embedding.java.JolieValue j ) {
                this.choice = jolie.runtime.embedding.java.util.ValueManager.fieldFrom( j.getFirstChild( "choice" ), joliex.meta.spec.types.ChoiceType::from );
            }
            
            public Builder choice( joliex.meta.spec.types.ChoiceType choice ) { this.choice = choice; return this; }
            public Builder choice( java.util.function.Function<joliex.meta.spec.types.ChoiceType.Builder, joliex.meta.spec.types.ChoiceType> f ) { return choice( f.apply( joliex.meta.spec.types.ChoiceType.builder() ) ); }
    ...
    public static final class S3 extends jolie.runtime.embedding.java.TypedStructure {
        ...
        public joliex.meta.spec.types.LocatedSymbolRef ref() { return ref; }
        ...
        public static S3 from( jolie.runtime.embedding.java.JolieValue j ) throws jolie.runtime.embedding.java.TypeValidationException {
            return new S3(
                jolie.runtime.embedding.java.util.ValueManager.fieldFrom( j.getFirstChild( "ref" ), joliex.meta.spec.types.LocatedSymbolRef::from )
            );
        }
        ...
        public static S3 fromValue( jolie.runtime.Value v ) throws jolie.runtime.typing.TypeCheckingException {
            jolie.runtime.embedding.java.util.ValueManager.requireChildren( v, FIELD_KEYS );
            return new S3(
                jolie.runtime.embedding.java.util.ValueManager.singleFieldFrom( v, "ref", joliex.meta.spec.types.LocatedSymbolRef::fromValue )
            );
        }
        ...
        public static class Builder {
            ...
            private Builder() {}
            private Builder( jolie.runtime.embedding.java.JolieValue j ) {
                this.ref = jolie.runtime.embedding.java.util.ValueManager.fieldFrom( j.getFirstChild( "ref" ), joliex.meta.spec.types.LocatedSymbolRef::from );
            }
            
            public Builder ref( joliex.meta.spec.types.LocatedSymbolRef ref ) { this.ref = ref; return this; }
            public Builder ref( java.util.function.Function<joliex.meta.spec.types.LocatedSymbolRef.Builder, joliex.meta.spec.types.LocatedSymbolRef> f ) { return ref( f.apply( joliex.meta.spec.types.LocatedSymbolRef.builder() ) ); }
    ...
    public static class ListBuilder extends jolie.runtime.embedding.java.util.AbstractListBuilder<ListBuilder, Type> {
        ...
        private ListBuilder() {}
        private ListBuilder( java.util.SequencedCollection<? extends jolie.runtime.embedding.java.JolieValue> c ) { super( c, Type::from ); }
        ...
        public java.util.List<Type> build() { return super.build(); }
    }
}