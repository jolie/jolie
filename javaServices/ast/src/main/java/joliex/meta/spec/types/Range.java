...
public final class Range extends jolie.runtime.embedding.java.TypedStructure {
	...
	public joliex.meta.spec.types.Position start() {
		return start;
	}

	public joliex.meta.spec.types.Position end() {
		return end;
	}
	...
	public static jolie.runtime.embedding.java.util.StructureListBuilder< Range, Builder > listBuilder() {
		return new jolie.runtime.embedding.java.util.StructureListBuilder<>( Range::builder );
	}

	public static jolie.runtime.embedding.java.util.StructureListBuilder< Range, Builder > listBuilder(
		java.util.SequencedCollection< ? extends jolie.runtime.embedding.java.JolieValue > from ) {
		return from != null
			? new jolie.runtime.embedding.java.util.StructureListBuilder<>( from, Range::from, Range::builder )
			: listBuilder();
	}

	public static Range from( jolie.runtime.embedding.java.JolieValue j )
		...
		return new Range(
			jolie.runtime.embedding.java.util.ValueManager.fieldFrom( j.getFirstChild( "start" ),
				joliex.meta.spec.types.Position::from ),
	...
	public static Range fromValue( jolie.runtime.Value v ) throws jolie.runtime.typing.TypeCheckingException {
		...
		return new Range(
			jolie.runtime.embedding.java.util.ValueManager.singleFieldFrom( v, "start",
				joliex.meta.spec.types.Position::fromValue ),
	...
	public static class Builder {
		...
		public Builder start( joliex.meta.spec.types.Position start ) {
			this.start = start;
			return this;
		}

		public Builder start(
			java.util.function.Function< joliex.meta.spec.types.Position.Builder, joliex.meta.spec.types.Position > f ) {
			return start( f.apply( joliex.meta.spec.types.Position.builder() ) );
		}

		public Builder end( joliex.meta.spec.types.Position end ) {
			this.end = end;
			return this;
		}
		...
		public Builder end(
			java.util.function.Function< joliex.meta.spec.types.Position.Builder, joliex.meta.spec.types.Position > f ) {
			return end( f.apply( joliex.meta.spec.types.Position.builder() ) );
		}
