 ...
 * @see #builder()
 */
public final class FaultType extends jolie.runtime.embedding.java.TypedStructure {
    
    private static final java.util.Set<java.lang.String> FIELD_KEYS = fieldKeys( FaultType.class );
    ...
    public FaultType( joliex.meta.spec.types.Location textLocation, joliex.meta.spec.types.LocatedString name, joliex.meta.spec.types.Type type ) {
    ...
    public static jolie.runtime.embedding.java.util.StructureListBuilder<FaultType, Builder> listBuilder() { return new jolie.runtime.embedding.java.util.StructureListBuilder<>( FaultType::builder ); }
    public static jolie.runtime.embedding.java.util.StructureListBuilder<FaultType, Builder> listBuilder( java.util.SequencedCollection<? extends jolie.runtime.embedding.java.JolieValue> from ) {
        return from != null ? new jolie.runtime.embedding.java.util.StructureListBuilder<>( from, FaultType::from, FaultType::builder ) : listBuilder();
    }
    
    public static FaultType from( jolie.runtime.embedding.java.JolieValue j ) throws jolie.runtime.embedding.java.TypeValidationException {
    ...
    public static FaultType fromValue( jolie.runtime.Value v ) throws jolie.runtime.typing.TypeCheckingException {
    ...
    public static jolie.runtime.Value toValue( FaultType t ) {
    ...
    public static class Builder {
        ...
        public FaultType build() {
            return new FaultType( textLocation, name, type );
        }
    }
}