...
public final class FaultType extends jolie.runtime.embedding.java.TypedStructure {
	...
	public FaultType( joliex.meta.spec.types.Location textLocation, joliex.meta.spec.types.LocatedString name,
	...
	public static jolie.runtime.embedding.java.util.StructureListBuilder< FaultType, Builder > listBuilder() {
		return new jolie.runtime.embedding.java.util.StructureListBuilder<>( FaultType::builder );
	}

	public static jolie.runtime.embedding.java.util.StructureListBuilder< FaultType, Builder > listBuilder(
		java.util.SequencedCollection< ? extends jolie.runtime.embedding.java.JolieValue > from ) {
		return from != null
			? new jolie.runtime.embedding.java.util.StructureListBuilder<>( from, FaultType::from, FaultType::builder )
			: listBuilder();
	}

	public static FaultType from( jolie.runtime.embedding.java.JolieValue j )
