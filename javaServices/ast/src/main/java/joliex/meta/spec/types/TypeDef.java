...
public final class TypeDef extends jolie.runtime.embedding.java.TypedStructure {
    ...
    public TypeDef( joliex.meta.spec.types.Location textLocation, joliex.meta.spec.types.LocatedString name, joliex.meta.spec.types.Type type ) {
    ...
    public static jolie.runtime.embedding.java.util.StructureListBuilder<TypeDef, Builder> listBuilder() { return new jolie.runtime.embedding.java.util.StructureListBuilder<>( TypeDef::builder ); }
    public static jolie.runtime.embedding.java.util.StructureListBuilder<TypeDef, Builder> listBuilder( java.util.SequencedCollection<? extends jolie.runtime.embedding.java.JolieValue> from ) {
        return from != null ? new jolie.runtime.embedding.java.util.StructureListBuilder<>( from, TypeDef::from, TypeDef::builder ) : listBuilder();
    }
    
    public static TypeDef from( jolie.runtime.embedding.java.JolieValue j ) throws jolie.runtime.embedding.java.TypeValidationException {
        return new TypeDef(
